...
type ModuleItem = { id: string; title: string; description: string; type: 'lesson' | 'practice' | 'case' | 'build' | 'assessment' | 'quiz' | 'submit' | 'reflect' | 'resource' | 'connect'; time?: string };
...
export default function Home() {
  ...
  function renderStructuredWeek() {
    ...
    const typeLabel: Record<ModuleItem['type'], string> = { lesson: 'LEARN', practice: 'PRACTICE', case: 'APPLY', build: 'BUILD', assessment: 'ASSESS', quiz: `QUIZ · ${quizTimerLabel} remaining`, submit: 'SUBMIT', reflect: 'REFLECT', resource: 'RESOURCES', connect: 'CONNECT' };
    ...
    const groups = ['lesson', 'practice', 'case', 'build', 'connect', 'quiz', 'assessment', 'submit', 'reflect', 'resource'] as ModuleItem['type'][];
    return <>
