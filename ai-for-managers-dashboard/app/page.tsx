...
export default function Home() {
  ...
  function renderStructuredWeek() {
    ...
    if (selectedItem) return <>
      ...
      {selectedItem.type === 'build' && (selectedWeek === 6 ? renderEthicsModule() : selectedWeek === 7 ? renderGovernanceModule() : renderStandardBuild())}
      ...
      {selectedItem.id === 'assessment-final-exam' && <section className="lmsPanel lessonGrid"><div className="panelBar"><h3>Final exam coverage</h3><span>Summative · 90 minutes</span></div><p>Answer questions across the full course: AI foundations and prompting; tools, productivity, decisions, and automation; ethics, bias, privacy, verification, and human oversight; governance, disclosure, values, and workforce impact; implementation, measurement, adoption, and testing.</p><p><strong>Scenario responses:</strong> distinguish facts from assumptions, verify evidence, identify affected stakeholders, recommend safeguards, assign accountability, and explain what would change your decision.</p></section>}
      {selectedItem.id === 'submit-final-paper' && <section className="lmsPanel lessonGrid"><div className="panelBar"><h3>Final paper requirements</h3><span>Due Week 15 · 1,500–2,000 words</span></div><ol><li>State the management problem and explain how AI could help.</li><li>Use at least three course artifacts from different weeks as evidence.</li><li>Analyze benefits, limitations, verification, privacy, ethical risk, human oversight, and organizational impact.</li><li>Recommend an implementation approach with policy controls, training, measures, and stop conditions.</li><li>Disclose meaningful AI assistance and verify all important claims and citations.</li></ol><p><strong>Suggested weighting:</strong> course synthesis 25%, evidence and verification 20%, ethical and governance analysis 25%, implementation recommendation 20%, disclosure and writing quality 10%.</p></section>}
