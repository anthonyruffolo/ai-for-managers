...
type ModuleItem = { id: string; title: string; description: string; type: 'lesson' | 'practice' | 'case' | 'build' | 'assessment' | 'quiz' | 'assignment' | 'submit' | 'reflect' | 'resource' | 'connect'; time?: string };
...
const standardModule = (week: number, overview: string, objectives: string[], artifact: string, buildDescription: string, lessons: string[], practice: string, assessment: string, submission: string) => ({
  ...
  items: [
    ...
    ...(week === 10 ? [
      { id: 'quiz-10-lesson-1', title: 'Quiz 1 · Lesson 1: Academic Integrity', description: 'Check your understanding of honest AI use, support versus substitution, disclosure, and student responsibility.', type: 'quiz' as const, time: '10 min' },
      { id: 'quiz-10-lesson-2', title: 'Quiz 2 · Lesson 2: Support vs. Substitution', description: 'Check your understanding of AI support, substitution, verification, and manager accountability.', type: 'quiz' as const, time: '10 min' },
      { id: 'quiz-10-lesson-3', title: 'Quiz 3 · Lesson 3: Attribution', description: 'Check your understanding of attribution, source verification, and transparent AI contribution.', type: 'quiz' as const, time: '10 min' },
      { id: 'quiz-10-lesson-4', title: 'Quiz 4 · Lesson 4: Disclosure Quality', description: 'Check your understanding of clear AI disclosures, human review, and responsibility.', type: 'quiz' as const, time: '10 min' },
      { id: 'assignment-10-lesson-1', title: 'Assignment · Academic Integrity Decision', description: 'Apply Lesson 1 concepts to a realistic student situation in a 100–150 word response.', type: 'assignment' as const, time: '30–45 min' },
    ...
    ...(week === 11 ? [
      ...
      { id: 'quiz-11-lesson-2', title: 'Quiz 2 · Lesson 2: Truthfulness in AI-Enabled Work', description: 'Check your understanding of verification, evidence, correction, and truthful communication in AI-enabled work.', type: 'quiz' as const, time: '10 min' },
      { id: 'quiz-11-lesson-3', title: 'Quiz 3 · Lesson 3: Justice and Fairness in AI-Enabled Work', description: 'Check your understanding of equitable treatment, fair evaluation, and responsible decisions when AI affects people.', type: 'quiz' as const, time: '10 min' },
      { id: 'quiz-11-lesson-4', title: 'Quiz 4 · Lesson 4: Stewardship in AI-Enabled Work', description: 'Check your understanding of wise resource use, protection of data, consideration of consequences, and human responsibility in AI-enabled work.', type: 'quiz' as const, time: '10 min' },
    ] : []),
...
const structuredModules: Record<number, { overview: string; objectives: string[]; artifact: string; buildDescription: string; items: ModuleItem[] }> = {
  1: {
    ...
    items: [
      ...
      { id: 'submit-1', title: 'Week 1 Submission', description: 'Submit the starter dashboard, README/project brief, repository link, screenshot, and AI-use disclosure.', type: 'submit' },
      { id: 'reflect-1', title: 'Week 1 Reflection', description: 'Explain what you learned about AI, the problem you are solving, and the responsibilities you must keep as the manager.', type: 'reflect', time: '15–20 min' },
      { id: 'resources-1', title: 'Week 1 Resources', description: 'Review the lesson, starter README guidance, GitHub workflow, and semester project overview before submitting.', type: 'resource' },
    ],
  },
  2: {
    overview: 'Week 2 helps managers understand, compare, and responsibly use AI tools in a business setting. Students learn common tool categories, strengths and limitations, privacy considerations, and how to choose an appropriate tool for a specific management task.',
    objectives: ['Define AI assistant, plugin, integration, API, and data privacy in plain language.', 'Identify common AI tools used in business and management.', 'Compare AI tools by purpose, strengths, limitations, risks, and appropriate use cases.', 'Evaluate which AI tool is most appropriate for a specific management task.', 'Recognize sensitive information that should not be entered into public AI tools.', 'Create an AI Tools page on the personal dashboard.'],
    artifact: 'AI Tools',
    ...
    items: [
      ...
      { id: 'scenario-2', title: 'Manager Scenario · Confidential Review', description: 'Evaluate whether a manager should paste a confidential employee review into a public AI tool and explain the safer decision path.', type: 'case', time: '20–30 min' },
  ...
  4: {
    overview: 'Week 4 focuses on using AI as a productivity tool for real management work: email, meeting summaries, research, brainstorming, presentations, project planning, task organization, and workflow automation. Compare a normal version of the task with an AI-assisted version and keep a human reviewing the result.',
    objectives: ['Use AI to draft emails, meeting summaries, and presentations.', 'Use AI to support research, brainstorming, and project planning.', 'Organize tasks and automate routine parts of a workflow with AI assistance.', 'Compare a normal management task with an AI-assisted process using time, quality, and risk.', 'Explain what a human must review before relying on an AI-assisted output.'],
    artifact: 'AI for Productivity',
    buildDescription: 'Add an AI Productivity section that applies AI to a real task such as email, meeting summaries, research, brainstorming, presentations, project planning, or workflow automation, and document the human review it required.',
    items: [
      ...['AI for Email and Meeting Summaries', 'AI for Research and Brainstorming', 'AI for Presentations and Project Planning', 'Task Organization and Workflow Automation', 'Productivity Gains and Human Review'].map((title, index) => ({ id: `lesson-${index + 1}`, title: `Lesson ${index + 1} · ${title}`, description: 'Learn the Week 4 concept, connect it to a management task, and identify what a manager must verify before acting.', type: 'lesson' as const, time: `${index < 2 ? 12 : 15} min` })),
  ...
  5: {
    overview: 'Week 5 focuses on using AI to support—not replace—a manager’s decision. Practice generating an AI recommendation, identifying missing information, comparing alternative solutions, verifying the output, and recognizing automation bias before making a final, accountable human decision.',
    objectives: ['Use AI to generate a decision recommendation for a real management scenario.', 'Identify missing information an AI recommendation did not account for.', 'Compare alternative solutions instead of accepting the first AI answer.', 'Verify AI-generated evidence, assumptions, and recommendations before acting.', 'Recognize automation bias and describe the human-in-the-loop review required.', 'Explain why the manager remains accountable for the final decision.'],
    artifact: 'Manager Decision Assistant',
    buildDescription: 'Add a Manager Decision Assistant that records a management problem, the AI-generated recommendation, missing information, alternative solutions, verification notes, and the final human decision.',
    items: [
      ...['AI Decision Support', 'Recommendations and Missing Information', 'Comparing Alternative Solutions', 'Verification and Automation Bias', 'Human-in-the-Loop and Manager Accountability'].map((title, index) => ({ id: `lesson-${index + 1}`, title: `Lesson ${index + 1} · ${title}`, description: 'Learn the Week 5 concept, connect it to a management decision, and identify what a manager must verify before acting.', type: 'lesson' as const, time: `${index < 2 ? 12 : 15} min` })),
      { id: 'practice-5', title: 'Manager Decision Practice Lab', description: 'Generate an AI recommendation for a management scenario, identify what information is missing, and compare it against at least one alternative solution.', type: 'practice' as const, time: '30–45 min' },
      { id: 'case-5', title: 'Management Case · AI-Assisted Decision', description: 'Work through a realistic management scenario where an AI recommendation looks confident but is missing key information, and decide what a manager should verify before acting.', type: 'case' as const, time: '30–45 min' },
      { id: 'build-5', title: 'Manager Decision Assistant', description: 'Add the Manager Decision Assistant and document the AI recommendation, missing information, alternatives considered, verification, and the final human decision.', type: 'build' as const, time: '2–3 hrs' },
      { id: 'assessment-5', title: 'Week 5 Knowledge Check', description: 'Check your understanding of AI decision support, missing information, alternative solutions, verification, automation bias, and manager accountability.', type: 'assessment' as const, time: '20–30 min' },
      { id: 'assessment-quiz-2', title: 'Quiz 2', description: 'Quiz 2: Prompting, Productivity, and Managerial Decision Support. Covers Week 4 and Week 5 concepts.', type: 'assessment' as const, time: '30–45 min' },
      { id: 'submit-5', title: 'Week 5 Submission', description: 'Submit the completed Manager Decision Assistant, the management case analysis, and evidence that the recommendation was verified before the final decision.', type: 'submit' as const },
      { id: 'reflect-5', title: 'Week 5 Reflection', description: 'Explain what the AI recommendation got right, what it missed, and how you decided when to trust it and when to override it.', type: 'reflect' as const, time: '15–20 min' },
      { id: 'resources-5', title: 'Week 5 Resources', description: 'Review the Week 5 lesson materials, decision-support examples, verification guidance, and automation-bias warnings before submitting.', type: 'resource' as const },
    ],
  },
  6: {
  ...
  8: standardModule(8, 'Turn customer information into a decision-ready brief. Separate evidence from assumptions, show where each insight came from, and make uncertainty visible before recommending action.', ['Create at least three customer insights supported by a named source.', 'Label each insight as observed, inferred, or AI-generated.', 'Identify one missing customer voice and one question that still needs validation.', 'Compare alternatives and recommend a decision with clear human accountability.'], 'Customer Evidence Decision Brief', 'Submit a decision brief with 3+ insights, a source note for every insight, evidence labels, one missing customer voice, one validation question, and a recommendation that explains tradeoffs and risk.', ['Evidence vs. Assumption', 'Customer Journey Evidence', 'Source Quality and Missing Voices', 'Decision Brief Example: Fictional Campus Support Service'], 'Evidence Labeling Practice', 'Customer Evidence Rubric: Evidence 40%, customer insight 30%, responsible AI 20%, clarity 10%', 'Week 8 Customer Evidence Decision Brief'),
    9: standardModule(9, 'Build a small AI-assisted workflow from one friction point identified in your Week 8 brief. The workflow must include a visible human review checkpoint, verification steps, and a clear owner for the final decision.', ['Connect the workflow to a documented Week 8 customer problem.', 'Define what AI may draft, summarize, or flag and what a person must review.', 'Add source, calculation, and uncertainty checks before an output is used.', 'Name an escalation trigger and the role accountable for the final decision.'], 'Human-Reviewed AI Workflow', 'Submit a workflow showing the Week 8 problem, AI-supported steps, the human reviewer, verification checks, an escalation trigger, and an accountable decision owner. Include one short fictional example from input to reviewed output.', ['From Week 8 Evidence to Workflow', 'Human Review Checkpoints', 'Verification and Escalation', 'Workflow Example: Fictional Student Support Triage'], 'Human Review Checkpoint Practice', 'Week 9 Workflow Rubric: usefulness 30%, human oversight 30%, verification 25%, clarity 15%', 'Week 9 Human-Reviewed Workflow'),
...
const week4Terms = [
  ['Workflow', 'A repeatable sequence of steps used to complete a task or process.'],
  ['Automation', 'Using a tool or system to perform part of a task automatically, while a human remains accountable.'],
  ['Productivity', 'The amount of useful output achieved relative to the time, effort, and resources used.'],
  ['Plugin', 'An add-on that extends a tool’s capabilities or connects it with other software.'],
  ['API', 'An application programming interface that lets software systems share data or functionality.'],
  ['Integration', 'The connection between systems or tools so they can work together as part of a process.'],
];

const week4Lessons = [
  ['AI and Managerial Productivity', 'AI helps managers complete repetitive work faster, such as drafting messages, summarizing notes, organizing tasks, and preparing first versions of documents. Managers remain responsible for the final result, including accuracy, tone, privacy, and business judgment. Productivity increases when AI handles routine work and the manager checks the outcome before using it.', 'Manager takeaway: AI is a speed tool, not a substitute for leadership responsibility.'],
  ['Email', 'AI can help managers draft professional emails, revise the tone, summarize long threads, and organize ideas before sending. It can also help turn notes into a clearer message with a stronger subject line and a more concise structure. The manager still decides the final wording, recipient, purpose, and whether the message is appropriate for the audience.', 'Manager takeaway: Use AI to improve clarity and speed, but review the email for tone, confidentiality, and business fit.'],
  ['Meeting Summaries', 'AI can summarize meetings, identify decisions, list action items, and draft follow-up communication. This is especially useful when a manager needs a quick recap after a long meeting or a busy week. The manager should check names, dates, responsibilities, and the accuracy of key decisions before sending the summary to others.', 'Manager takeaway: AI helps capture the conversation, but a manager must verify the record before acting on it.'],
  ['Research', 'AI can help managers gather information, organize sources, summarize articles, and compare ideas. It can identify themes, pull together notes, and help a manager see patterns faster. However, important facts, claims, calculations, and sources still require verification. Managers must confirm that the information is current, relevant, and credible before using it in a decision.', 'Manager takeaway: AI speeds up research, but verification protects the manager from bad information and weak reasoning.'],
  ['Brainstorming', 'AI can generate ideas, alternatives, and possible strategies for a business problem. It can help expand a manager’s thinking by suggesting categories, options, scenarios, and different approaches. The manager then evaluates which ideas are realistic, useful, aligned with goals, and appropriate for the organization.', 'Manager takeaway: AI expands the conversation; the manager still decides which ideas are worth pursuing.'],
  ['Presentations', 'AI can help managers build outlines, organize information, create talking points, and improve presentation preparation. It can suggest a structure, summarize key points, and draft speaker notes. A manager should review the slides for clarity, accuracy, tone, evidence, and whether the message fits the audience and purpose.', 'Manager takeaway: AI can improve preparation, but the manager must ensure the content is accurate and persuasive.'],
  ['Project Planning', 'AI can help managers organize tasks, timelines, dependencies, responsibilities, and planning information. It can create a draft plan, highlight missing steps, and identify areas where coordination may be needed. The manager should check the assumptions, staffing, deadlines, and feasibility of the plan before sharing it with others.', 'Manager takeaway: AI can support planning, but responsibility for the final plan remains with the manager.'],
  ['Task Organization', 'AI can help managers prioritize and categorize work, especially when there are many emails, projects, and deadlines. It can sort tasks by urgency, group similar responsibilities, and suggest a cleaner workload structure. The manager still decides priorities based on business goals, people, and risk.', 'Manager takeaway: AI is useful for organizing complexity, but managers must decide what matters most.'],
  ['Workflow and Automation', 'A workflow is a sequence of steps used to move work from start to finish. AI can assist with one or more steps in a workflow, such as drafting a summary or sorting items. Automation goes further by triggering actions with less human intervention. For example, AI may draft a meeting recap, while automation routes it to the right team or generates a follow-up task list.', 'Manager takeaway: AI assistance is not the same as full workflow automation, and automation requires careful review and safeguards.'],
  ['Human Review', 'Managers must review AI-generated work for accuracy, quality, privacy, tone, and appropriateness. Even when the output looks polished, it can still be wrong, outdated, overly generic, or missing important context. Human review is also essential for confidentiality, decision-making, fairness, and maintaining accountability for the final result.', 'Manager takeaway: The manager’s judgment is the quality control step that keeps AI outputs useful and appropriate.'],
];

const week4PracticeTask = 'A manager is preparing a weekly team meeting summary and needs to send a follow-up email with action items. The manager must also decide whether important decisions or concerns need a follow-up conversation before the email is sent.';

const week4WorkedExample = {
  managementTask: 'Prepare a weekly team meeting summary and send a follow-up email with action items.',
  normalProcess: 'Review meeting notes, identify the key decisions, draft the summary manually, check names and dates, write the follow-up email, and revise both documents before sending.',
  aiAssistedProcess: 'Use AI to summarize the meeting notes, surface key decisions and action items, draft a concise summary, and generate a first-pass follow-up email. Then review the draft for accuracy, tone, missing context, and confidentiality before sending.',
  normalTime: 75,
  aiAssistedTime: 25,
  qualityChange: 'Faster draft creation and better organization, but the manager still needs to check action items, names, dates, and business context.',
  risks: 'AI may miss a decision, misstate a deadline, overgeneralize a concern, or include inaccurate wording. If sent without review, the team could act on the wrong information.',
  humanReviewRequired: 'Verify the summary and action items, confirm deadlines and owners, check tone and confidentiality, and make final edits before sending.',
};

const week4Rubric = [
  ['Completion', 'Student completes the full AI Productivity assignment and records all required fields.'],
  ['Comparison Quality', 'The normal process and AI-assisted process are clearly compared and reflect a realistic managerial task.'],
  ['Time/Productivity Analysis', 'The student estimates time required, compares the processes, and explains the time saved or gained.'],
  ['Identification of Risks', 'The assignment identifies likely risks, inaccuracies, or weaknesses in the AI-assisted approach.'],
  ['Human Review Explanation', 'The student clearly explains what must still be reviewed by a manager before relying on the output.'],
  ['Clarity', 'The final response is organized, professional, and easy for a reader to understand.'],
];

const week5Terms = [
  ['Decision Support', 'Information, analysis, or suggestions that help a manager make a decision without making the decision for them.'],
  ['Human-in-the-Loop', 'A process in which a qualified person reviews, interprets, and can change or stop an AI-supported decision.'],
  ['Recommendation', 'An AI-generated suggestion about what might be done; it is not a final managerial decision.'],
  ['Verification', 'Checking important claims, data, assumptions, and context before relying on an AI output.'],
  ['Automation Bias', 'The tendency to trust an automated recommendation too much simply because a system produced it.'],
];

const week5Lessons = [
  ['AI Decision Support', 'AI can organize a problem, sort information, summarize reports, and compare factors so a manager can see a decision more clearly. It is a support tool: the manager still defines the goal, considers the people affected, and decides what action is appropriate.', 'AI recommends. Managers decide.'],
  ['AI Analysis', 'AI can identify patterns, summarize information, and highlight relationships that deserve attention. A pattern is not automatically a cause, and a summary can leave out context. Treat analysis as a useful starting point for questions and investigation.', 'Ask what the pattern means and what evidence could confirm it.'],
  ['AI Recommendations', 'An AI recommendation is a suggestion based on the information and instructions it received. It may sound confident even when the input is incomplete. A manager should label the recommendation separately from the final decision and explain why the decision was accepted, changed, or rejected.', 'A recommendation informs judgment; it does not replace judgment.'],
  ['Alternative Solutions', 'The first AI recommendation is only one option. Managers should ask for at least two realistic alternatives and compare likely benefits, costs, feasibility, people impacts, and risks before choosing a path.', 'Good decisions come from comparison, not automatic acceptance.'],
  ['Missing Information', 'AI can only work with the information available to it. It may not know local conditions, employee history, informal communication problems, current policies, or facts that were never included in the prompt. Missing information can change the recommendation.', 'Name the unknowns before making a major decision.'],
  ['Verification', 'Verify important information before acting. Check sources, dates, calculations, assumptions, and whether the evidence actually supports the recommendation. The higher the consequence, the more careful and qualified the review should be.', 'Confidence and fluency are not proof.'],
  ['Automation Bias', 'Automation bias occurs when a person gives an automated output more trust than it deserves. A manager may accept a recommendation because it appears objective, fast, or data-driven. Slow down when the output affects people, money, safety, or employment.', 'A polished recommendation still needs independent review.'],
  ['Human-in-the-Loop', 'Important managerial decisions need a human who understands the context, has time to review the evidence, can question the AI output, and has authority to override or stop the process. A person merely clicking approve is not meaningful human review.', 'Human review must have information, expertise, and authority.'],
  ['Risks and Consequences', 'Consider what could happen if the recommendation is incomplete or wrong. Identify who could be harmed, how difficult the mistake would be to reverse, and what safeguards or pilot steps could reduce the risk before action.', 'Plan for failure, not only the hoped-for benefit.'],
  ['Manager Accountability', 'The manager and organization remain responsible for the final decision and its consequences. Saying “the AI told me to” does not transfer accountability. Document the evidence reviewed, alternatives considered, decision made, and reason for that decision.', 'Managers own the decision even when AI helps with the work.'],
];

const week5PracticeTask = 'A department has experienced increased employee turnover during the last six months. Use the evidence provided, identify what is missing, and decide what a manager should do before making a major change.';

const week5Case = {
  available: ['Turnover has increased during the last six months.', 'Exit comments mention workload and communication.', 'Overtime has increased.', 'Employee satisfaction has declined.', 'Two experienced supervisors recently left.', 'Productivity has declined.'],
  missing: ['Compensation compared with competitors.', 'Turnover by supervisor or department.', 'Employee tenure and role mix.', 'Promotion opportunities.', 'Scheduling concerns.', 'Detailed exit interview results.', 'Local labor-market conditions.'],
  aiAnalysis: 'The pattern suggests that workload, communication, and supervisor loss may be contributing to turnover and lower productivity. Compensation could also be a factor, but the available information does not establish the cause.',
  aiRecommendation: 'Increase employee compensation to improve retention, then monitor turnover and productivity.',
  alternatives: ['Review workload, overtime, and schedules; repair communication routines; and support supervisors.', 'Gather employee feedback and improve promotion or development opportunities.', 'Run a targeted retention pilot in the highest-turnover area before changing compensation across the department.'],
  risks: 'Increasing compensation without knowing the cause could spend money without improving retention. Acting on an incomplete diagnosis could overlook scheduling, supervision, promotion, or labor-market issues. Delaying action too long could also worsen turnover and productivity.',
  decision: 'Do not immediately change compensation. First review exit interviews, gather compensation benchmarking information, compare turnover across supervisors, review workload and overtime, and gather employee feedback. Reassess the options after this evidence is available.',
  reason: 'The AI recommendation is a useful hypothesis, not enough evidence for a major compensation decision. The next step reduces uncertainty, addresses urgent workload and communication concerns, and keeps the manager accountable for choosing an evidence-based response.',
};

const week5Rubric = [
  ['Problem analysis', 'Defines the management problem and separates known facts from assumptions.'],
  ['AI recommendation evaluation', 'Explains what the recommendation uses, what it assumes, and whether it is strong enough to act on.'],
  ['Missing information', 'Identifies important unknowns that could change the decision.'],
  ['Alternative solutions', 'Compares multiple realistic options rather than accepting the first recommendation.'],
  ['Verification', 'Names specific information, sources, calculations, or stakeholder feedback to verify.'],
  ['Risks', 'Explains likely consequences if the recommendation or decision is incomplete or wrong.'],
  ['Final managerial decision', 'Makes a practical, accountable decision that fits the evidence and risk.'],
...
const quiz2Questions: QuizQuestion[] = [
  { question: 'A manager asks AI to draft a staffing plan. Which prompt is most useful?', options: ['Make a staffing plan.', 'Make it good.', 'Create a two-week staffing plan for a six-person team, using the listed availability, coverage rules, and a table format.', 'Use your best judgment.'], answer: 2, explanation: 'A strong prompt supplies context, the task, constraints, and an output format.' },
  { question: 'Why should a prompt include context?', options: ['Context guarantees the answer is correct.', 'Context helps the tool understand the situation, audience, and relevant information.', 'Context lets the manager skip review.', 'Context removes the need for constraints.'], answer: 1, explanation: 'Context helps AI produce a response that fits the actual management situation.' },
  { question: 'A first AI response is too general. What should the manager do?', options: ['Accept it because the first response is fastest.', 'Revise the prompt with clearer context, constraints, and a desired format.', 'Ask a coworker to guess what AI meant.', 'Remove all context from the prompt.'], answer: 1, explanation: 'Prompt revision is an iterative way to improve usefulness and fit.' },
  { question: 'Which item is a constraint in a management prompt?', options: ['The team is preparing a report.', 'The audience is a department manager.', 'Use no confidential employee information and keep the response under 200 words.', 'The manager wants help.'], answer: 2, explanation: 'Constraints define limits such as privacy, length, time, or required boundaries.' },
  { question: 'AI summarizes a meeting and drafts follow-up email. What is the manager’s best next step?', options: ['Send it immediately because the summary is polished.', 'Review names, dates, decisions, owners, tone, and confidentiality before sending.', 'Ask AI to sound more certain.', 'Delete the original notes.'], answer: 1, explanation: 'Human review protects accuracy, context, tone, and confidentiality.' },
  { question: 'Which workflow uses AI appropriately?', options: ['AI automatically terminates employees based on a score.', 'AI drafts a customer response and a trained employee verifies it before sending.', 'AI receives passwords to complete tasks faster.', 'AI publishes every generated report without review.'], answer: 1, explanation: 'Bounded assistance with a human checkpoint is appropriate for many routine workflows.' },
  { question: 'What is a useful productivity measure for an AI-assisted task?', options: ['Whether the output sounds impressive.', 'Time saved together with quality, error, and review requirements.', 'How confident the AI sounds.', 'How little the manager knows about the process.'], answer: 1, explanation: 'Productivity includes useful output, time, quality, risk, and the work still required.' },
  { question: 'What is AI decision support?', options: ['Allowing AI to make all management decisions.', 'Using AI to organize information and support a manager’s reasoning.', 'Replacing evidence with a generated opinion.', 'Using automation without an owner.'], answer: 1, explanation: 'Decision support helps a manager reason while leaving the final decision with the manager.' },
  { question: 'An AI recommendation is best understood as:', options: ['A final decision that must be followed.', 'A suggestion based on available inputs and assumptions.', 'Proof that the underlying cause is known.', 'An accountability transfer to the vendor.'], answer: 1, explanation: 'Recommendations are inputs to judgment, not final decisions or proof.' },
  { question: 'A turnover analysis recommends higher pay, but competitor compensation data is missing. What should the manager do?', options: ['Approve the pay increase immediately.', 'Ignore the recommendation completely.', 'Gather compensation data and investigate other possible causes before deciding.', 'Ask AI to hide the missing data.'], answer: 2, explanation: 'Missing information may change the recommendation, so it should be gathered and verified.' },
  { question: 'Why should a manager compare alternative solutions?', options: ['To make the decision take longer without benefit.', 'To avoid being anchored to the first AI suggestion and compare tradeoffs.', 'To prove AI is always wrong.', 'To remove human judgment.'], answer: 1, explanation: 'Comparing alternatives reduces anchoring and makes tradeoffs visible.' },
  { question: 'Which action is verification?', options: ['Trusting a precise percentage because it sounds objective.', 'Checking the source, date, calculation, and assumptions behind an AI claim.', 'Changing the font of an AI report.', 'Using the recommendation in a high-stakes decision without review.'], answer: 1, explanation: 'Verification checks whether important information and reasoning are reliable enough to use.' },
  { question: 'Automation bias is:', options: ['A system that never produces errors.', 'Trusting an automated output too much because it came from an automated system.', 'A requirement that every task be automated.', 'A method for improving prompt format.'], answer: 1, explanation: 'Automation bias can make people overlook errors or missing context.' },
  { question: 'Human-in-the-loop means that a human:', options: ['Is present but cannot question the output.', 'Reviews the relevant evidence and can change or stop the decision.', 'Only approves the AI vendor invoice.', 'Must write every part of the task manually.'], answer: 1, explanation: 'Meaningful human review requires information, judgment, and authority to intervene.' },
  { question: 'Who is accountable when a manager acts on an AI recommendation?', options: ['The AI system alone.', 'Only the person who wrote the prompt.', 'The responsible manager and organization remain accountable for the final decision.', 'Nobody if the recommendation was generated automatically.'], answer: 2, explanation: 'AI assistance does not remove managerial or organizational accountability.' },
];

const lesson1KnowledgeQuestions: QuizQuestion[] = [
  { question: 'What is an AI model?', options: ['A person who reviews every AI answer.', 'A trained system that recognizes patterns and produces outputs from inputs.', 'A database containing only verified facts.', 'A guarantee that an answer is correct.'], answer: 1, explanation: 'A model is a trained system that generates outputs from patterns learned from data.' },
  { question: 'How is an AI tool different from a model?', options: ['A tool applies one or more models through an interface, workflow, or service.', 'A tool is always more accurate than its model.', 'A tool can only be used by programmers.', 'There is no difference.'], answer: 0, explanation: 'An AI tool packages a model into a usable interface or workflow for a task.' },
  { question: 'What is a hallucination?', options: ['A response that is slow but accurate.', 'A response that sounds plausible but is unsupported or false.', 'A private data setting.', 'A human review step.'], answer: 1, explanation: 'A hallucination is an unsupported or false output that may still sound confident and plausible.' },
  { question: 'What should a manager do before relying on an important AI-generated claim?', options: ['Use it immediately if the writing sounds confident.', 'Ask the AI to sound more certain.', 'Verify the source, evidence, calculations, and assumptions.', 'Remove the human reviewer to save time.'], answer: 2, explanation: 'Important claims need verification before they inform a consequential action or decision.' },
  { question: 'Who remains accountable when AI helps with management work?', options: ['The AI tool vendor alone.', 'The model itself.', 'The manager and organization responsible for the work and decision.', 'No one if AI generated the recommendation.'], answer: 2, explanation: 'AI assistance does not transfer accountability away from the people and organization using it.' },
];

const academicIntegrityQuestions: QuizQuestion[] = [
  { question: 'Which statement best describes academic integrity when using AI?', options: ['Students should use AI honestly and remain responsible for their work', 'Students are not responsible for errors produced by AI', 'Students can submit AI-generated work if they change a few words', 'Students should never use AI for academic work'], answer: 0, explanation: 'Academic integrity requires honest use and responsibility for the submitted work.' },
  { question: 'A student writes an assignment independently and uses AI only to check grammar. Which description best fits this use?', options: ['The student is submitting entirely AI-generated work', 'AI is completing the assignment for the student', 'AI is supporting the student\'s original work', 'The student is creating false academic sources'], answer: 2, explanation: 'Grammar support can assist the student\'s original work when it follows the course rules.' },
  { question: 'A student asks AI to write an entire assignment and submits it as their own work. What is the primary academic integrity concern?', options: ['The assignment may contain better grammar', 'The submitted work does not represent the student\'s own contribution', 'The student completed the assignment too quickly', 'The student used technology during the assignment'], answer: 1, explanation: 'Submitting generated work as one\'s own misrepresents who contributed the ideas and writing.' },
  { question: 'When AI significantly contributes to an assignment, what should a student do when disclosure is required by the course?', options: ['Hide the AI use after editing the output', 'Disclose how AI contributed to the assignment', 'Delete all evidence that AI was used', 'Assume the instructor will recognize the AI content'], answer: 1, explanation: 'Required disclosure makes meaningful AI assistance traceable and transparent.' },
  { question: 'Who is ultimately responsible for verifying AI-generated information before it is submitted in a student\'s assignment?', options: ['The student', 'The software developer', 'The AI tool', 'The instructor'], answer: 0, explanation: 'The student remains responsible for checking the accuracy and appropriateness of submitted work.' },
];

const supportSubstitutionQuestions: QuizQuestion[] = [
  { question: 'What does it mean when AI is used to support a manager?', options: ['AI assists with the task while the manager remains involved and responsible', 'AI becomes responsible for the consequences of the decision', 'AI replaces all human review of the task', 'AI independently makes the final management decision'], answer: 0, explanation: 'Support means AI assists while the manager remains involved and accountable for the final result.' },
  { question: 'Which example best demonstrates AI supporting rather than substituting for a manager?', options: ['AI independently decides which employees receive promotions', 'AI automatically rejects job applicants without human review', 'AI issues employee discipline without managerial approval', 'AI summarizes survey responses and the manager reviews the findings'], answer: 3, explanation: 'The manager reviews the summarized information and remains responsible for deciding what to do.' },
  { question: 'Why should a manager verify important AI-generated recommendations before acting on them?', options: ['AI cannot assist with any management tasks', 'Managers must personally perform every task without technology', 'AI outputs can contain errors, limitations, or bias', 'AI recommendations are always intentionally misleading'], answer: 2, explanation: 'Verification helps identify errors, limitations, bias, and missing context before action.' },
  { question: 'An AI system recommends which job applicants should receive interviews. What is the manager\'s most important responsibility before relying on the recommendations?', options: ['Ignore how the recommendations were produced as long as they save time', 'Accept the recommendations because AI processed the applications efficiently', 'Allow the AI system to make the final hiring decision automatically', 'Review the recommendations, relevant evidence, and potential risks before deciding'], answer: 3, explanation: 'The manager must review the evidence and risks and retain responsibility for the final decision.' },
  { question: 'Which question best helps a manager distinguish AI support from AI substitution?', options: ['Is the AI tool popular with other organizations?', 'Is AI helping a person decide, or making the decision for the person?', 'Is the AI tool producing its answer quickly?', 'Does the AI output contain professional-looking language?'], answer: 1, explanation: 'The key distinction is whether AI assists human judgment or replaces the decision-maker.' },
];

const attributionQuestions: QuizQuestion[] = [
  { question: 'What is the main purpose of attribution?', options: ['To clearly identify where information, ideas, or content came from', 'To allow managers to avoid verifying information', 'To transfer responsibility for the report to another person', 'To make a report longer and more detailed'], answer: 0, explanation: 'Attribution makes the origin of information, ideas, and content clear.' },
  { question: 'A manager uses AI to generate statistics for a report. What should the manager do before including those statistics?', options: ['Assume another team member will check them later', 'Verify the statistics using reliable sources', 'Use them immediately because AI generated them confidently', 'Remove all information about where the statistics originated'], answer: 1, explanation: 'Important statistics should be checked against reliable sources before they inform a report.' },
  { question: 'When AI meaningfully contributes to a report, what practice best supports transparency?', options: ['Disclose the AI contribution when appropriate and explain how it was used', 'Avoid reviewing the AI contribution once it has been generated', 'Present all AI-generated content as independently created by the manager', 'Hide the AI contribution if the final report looks professional'], answer: 0, explanation: 'Appropriate disclosure explains the meaningful role AI played in creating the work.' },
  { question: 'AI provides an important claim for a management report, but the manager cannot verify its source. What is the most responsible response?', options: ['Include the claim because it sounds reasonable', 'Verify the claim independently or leave it out', 'Attribute the claim only to the AI tool and assume it is accurate', 'Include the claim but remove specific details'], answer: 1, explanation: 'An important claim should be independently verified or excluded when its source cannot be confirmed.' },
  { question: 'Which question best helps a manager practice responsible attribution when using AI?', options: ['Did AI produce the information faster than I could?', 'Does the AI-generated content sound professional?', 'Can I remove the sources to make the report shorter?', 'Can I explain where this information came from and how AI contributed?'], answer: 3, explanation: 'Responsible attribution requires tracing the information and explaining AI\'s contribution.' },
];

const disclosureQualityQuestions: QuizQuestion[] = [
  { question: 'What is the main purpose of a high-quality AI disclosure?', options: ['To prove that AI produced accurate information', 'To explain clearly how AI contributed to the work', 'To prevent managers from using AI tools', 'To transfer responsibility for the work to AI'], answer: 1, explanation: 'A high-quality disclosure makes AI\'s contribution to the work clear.' },
  { question: 'Which statement provides the strongest AI disclosure?', options: ['Technology was used while preparing this report.', 'AI helped me with my work.', 'I used AI.', 'I used ChatGPT to organize ideas, then revised the recommendations and verified key claims.'], answer: 3, explanation: 'The strongest disclosure names the tool, its role, and the human review performed.' },
  { question: 'Which information is most useful to include in an AI disclosure?', options: ['The tool used, its role, and the human review performed', 'Only the name of the AI company', 'Only whether the final output looked professional', 'Only the amount of time saved by using AI'], answer: 0, explanation: 'A useful disclosure explains the tool, contribution, and human review.' },
  { question: 'A manager uses AI to draft recommendations and then significantly revises and verifies them. What should the disclosure communicate?', options: ['How AI assisted and how the manager revised and verified the output', 'Only that the manager wrote the final version', 'That AI is responsible for any remaining mistakes', 'Nothing, because revising the output eliminates the AI contribution'], answer: 0, explanation: 'The disclosure should describe both AI assistance and the manager\'s revisions and verification.' },
  { question: 'Which question best helps a manager evaluate the quality of an AI disclosure?', options: ['Does the disclosure make the report appear more advanced?', 'Does the disclosure remove the manager\'s responsibility?', 'Does the disclosure guarantee that AI made no errors?', 'Does the disclosure clearly explain how AI contributed to the work?'], answer: 3, explanation: 'The key test is whether a reader can understand how AI contributed to the work.' },
];

const humanDignityQuestions: QuizQuestion[] = [
  { question: 'A manager uses AI to screen job applications. The AI recommends rejecting a candidate, but it does not clearly explain why. What should the manager do?', options: ['Reject the candidate because AI analyzed the information', 'Accept the AI recommendation to save time', 'Review the recommendation and ensure the candidate is evaluated fairly', 'Remove the candidate from the system'], answer: 2, explanation: 'A manager should review the recommendation and ensure the candidate is assessed fairly, with human judgment and clear reasoning.' },
  { question: 'A company wants to use AI to monitor employee productivity throughout the workday. What should the manager consider before implementing the system?', options: ['Whether the system will increase profits', 'How the system could affect employees, their privacy, and their dignity', 'Whether other companies use similar technology', 'How quickly the system can be installed'], answer: 1, explanation: 'The manager should consider the impact on employees, privacy, and human dignity before adopting the system.' },
  { question: 'An AI system recommends terminating an employee because of poor performance data. What is the manager’s best next step?', options: ['Terminate the employee immediately', 'Allow the AI system to make the final decision', 'Ignore the recommendation completely', 'Review the evidence and relevant circumstances before making a human decision'], answer: 3, explanation: 'A human manager must review the evidence, context, and relevant circumstances before making a consequential decision.' },
  { question: 'A customer-service AI provides a confident answer to a customer complaint, but the manager cannot verify whether the information is accurate. What should the manager do?', options: ['Verify the information before allowing it to affect the customer', 'Use the answer because the AI sounds confident', 'Assume the AI has access to accurate information', 'Send the response immediately to improve efficiency'], answer: 0, explanation: 'Verification is necessary before a customer-facing decision or response is influenced by AI output.' },
  { question: 'A manager uses AI to help decide employee work schedules. Several employees could be negatively affected by the recommendation. Who is ultimately responsible for the decision?', options: ['The AI provider', 'The scheduling software', 'The manager or responsible human decision-maker', 'The employees affected by the schedule'], answer: 2, explanation: 'The manager or responsible human decision-maker remains accountable for the final scheduling decision and its consequences.' },
];

const truthfulnessQuestions: QuizQuestion[] = [
  { question: 'A manager uses AI to create a report for senior leadership. The report includes statistics that the manager cannot verify. What should the manager do?', options: ['Include the statistics because AI generated them', 'Verify the statistics using reliable evidence before presenting the report', 'Present the report but remove the source information', 'Assume the statistics are accurate if they sound reasonable'], answer: 1, explanation: 'Truthful AI use requires verification of important facts and statistics before presenting them as evidence.' },
  { question: 'An AI tool creates a product description claiming the company’s product is “proven to reduce costs by 40%.” The company has no evidence supporting this claim. What should the manager do?', options: ['Use the claim because it could increase sales', 'Change the percentage to a smaller number', 'Publish the description and correct it later if necessary', 'Remove or revise the claim unless reliable evidence supports it'], answer: 3, explanation: 'A manager should not present unverified claims as proven facts; unsupported claims should be revised or removed.' },
  { question: 'A manager discovers that an AI-generated presentation contains inaccurate information after it has been shared with employees. What action best demonstrates truthfulness?', options: ['Correct the inaccurate information and communicate the correction', 'Leave the presentation unchanged because it has already been shared', 'Blame the AI system for the mistake', 'Wait to see whether employees notice the error'], answer: 0, explanation: 'Truthfulness includes correcting misinformation and clearly communicating the correction.' },
  { question: 'AI generates a confident summary of customer feedback, but the manager notices that several important negative comments are missing. What should the manager do before making a decision?', options: ['Use the summary because AI analyzed the data', 'Focus only on the positive feedback', 'Review the original customer feedback and verify that the summary accurately represents it', 'Ask AI to make the summary sound more convincing'], answer: 2, explanation: 'A manager should verify the summary against the original evidence before relying on it.' },
  { question: 'A manager uses AI to prepare financial information for an important meeting. Who is responsible for ensuring that the information presented is truthful and accurate?', options: ['The AI system', 'The software company', 'The manager or responsible human decision-maker', 'The meeting participants'], answer: 2, explanation: 'The manager or responsible human decision-maker remains accountable for the truthfulness and accuracy of the information presented.' },
];

const justiceFairnessQuestions: QuizQuestion[] = [
  { question: 'A company uses AI to recommend employees for promotions. A manager notices that employees from one department are consistently ranked lower even though they have similar performance records. What should the manager do?', options: ['Follow the AI rankings because they are automated', 'Review the system and evidence for possible unfair differences before making promotion decisions', 'Promote only the highest-ranked employees', 'Allow the AI provider to make the final decision'], answer: 1, explanation: 'Fair use of AI requires checking whether the system is producing uneven outcomes and investigating before decisions are made.' },
  { question: 'An AI hiring system consistently recommends candidates from similar backgrounds while overlooking other qualified applicants. What is the manager’s responsibility?', options: ['Investigate whether the system is evaluating candidates fairly and review the results before making decisions', 'Trust the system because it uses data', 'Continue using the recommendations because they save time', 'Remove human involvement from the hiring process'], answer: 0, explanation: 'Managers must examine whether the system is fair and decide with human review rather than accepting biased recommendations.' },
  { question: 'A manager uses AI to determine employee work schedules. The system repeatedly gives certain employees less desirable shifts without a clear business reason. What should the manager do?', options: ['Keep the schedule because AI created it', 'Tell employees that the system cannot be changed', 'Allow employees to solve the problem themselves', 'Review how shifts are assigned and make changes if employees are being treated unfairly'], answer: 3, explanation: 'Fairness requires reviewing whether the allocation process is producing unjust treatment and correcting it if needed.' },
  { question: 'Before using an AI system to determine which employees receive bonuses, what evidence should a manager review?', options: ['Whether the AI system produces results quickly', 'Whether employees like using AI', 'Whether the criteria and outcomes are consistent, relevant, and fair across employees', 'Whether the AI system reduces the manager’s workload'], answer: 2, explanation: 'A manager should check whether the criteria and outcomes are consistent, relevant, and fair across employees before accepting AI-driven bonus decisions.' },
  { question: 'An AI system recommends denying a customer access to a company service. The manager cannot determine what information led to the recommendation. What is the best next step?', options: ['Deny the service because the AI made the recommendation', 'Review the evidence and decision process before taking action that affects the customer', 'Assume the system treats every customer fairly', 'Remove the customer’s information from the system'], answer: 1, explanation: 'Managers must understand the basis for an AI recommendation and review the evidence before making a consequential customer decision.' },
];

const stewardshipQuestions: QuizQuestion[] = [
  { question: 'A manager wants to purchase an expensive AI system because it promises to increase productivity. What should the manager do before making the investment?', options: ['Purchase it because AI will improve the organization', 'Evaluate the costs, benefits, risks, and impact on the organization and its people', 'Choose the most expensive system available', 'Allow the AI company to make the decision'], answer: 1, explanation: 'Good stewardship requires evaluating whether the tool is a wise and responsible use of resources before buying it.' },
  { question: 'A company uses AI to analyze confidential employee information. What action best demonstrates good stewardship?', options: ['Protect the information and ensure it is used only for appropriate business purposes', 'Allow all employees to access the information', 'Share the information with other organizations', 'Use the data for any purpose that benefits the company'], answer: 0, explanation: 'Stewardship means protecting sensitive information and using it only in appropriate, justified ways.' },
  { question: 'An AI system recommends reducing staff to save the company money. What should the manager do before acting on the recommendation?', options: ['Reduce staff immediately because it saves resources', 'Allow the AI system to choose which employees should leave', 'Review the evidence and consider the financial, operational, and human consequences', 'Accept the recommendation if the company can increase profits'], answer: 2, explanation: 'Stewardship requires considering both the resource benefits and the human and operational consequences before acting.' },
  { question: 'A manager discovers that employees are using a company AI tool in ways that waste resources and create unnecessary risks. What best demonstrates stewardship?', options: ['Ignore the issue because employees are responsible for their own AI use', 'Stop using all AI technology', 'Allow employees to continue if their work gets completed', 'Establish responsible guidelines and monitor how the AI tool and company resources are being used'], answer: 3, explanation: 'Stewardship includes setting responsible boundaries and monitoring technology use to protect organizational resources and people.' },
  { question: 'Who is ultimately responsible for ensuring that AI is used wisely and responsibly when making an important management decision?', options: ['The AI system', 'The manager or responsible human decision-maker', 'The software provider', 'The employees affected by the decision'], answer: 1, explanation: 'The manager or responsible human decision-maker remains accountable for responsible, wise use of AI and the consequences of the decision.' },
];
...
const weeklyPlan = [
  ...
  { week: 8, dates: 'Oct 12–18', title: 'AI in Management', learn: 'AI in leadership and communication, planning, project management, agents, decision support, and human-in-the-loop judgment.', build: 'Add a Manager AI Assistant that prepares a decision brief with context, options, tradeoffs, risks, and a clearly labeled human decision.', test: 'Challenge assumptions, missing information, unsupported recommendations, and places where human review is required.', manage: 'Keep decision rights with the manager and define when AI output must be verified, revised, or escalated.', present: 'Compare the AI recommendation with your own management decision and identify the evidence still needed.', output: 'Manager AI Assistant + decision brief', studentQuestion: 'How can AI help a manager without replacing human judgment?', studentWin: 'Use AI to frame and compare management options while keeping the final decision human.', career: 'Use AI as decision support without surrendering accountability.', workload: '7–9 hours' },
  { week: 9, dates: 'Oct 19–25', title: 'Accuracy, Hallucinations, and Verification', learn: 'Hallucinations, source quality, claim verification, calculation checks, uncertainty, and correction workflows.', build: 'Add an AI Verification Center that records the claim, source, verification method, result, correction, and confidence level.', test: 'Audit AI-generated claims for source quality, math, unsupported causal language, stale information, and unresolved uncertainty.', manage: 'Require evidence before acting on consequential AI output and document corrections when the output is wrong.', present: 'Show what was confirmed, corrected, or left unresolved and explain why.', output: 'AI Verification Center + Quiz 3', studentQuestion: 'How can a manager verify AI output before acting on it?', studentWin: 'Turn verification into a repeatable management checkpoint instead of trusting fluent output.', career: 'Verify AI-assisted work before it informs business decisions.', workload: '7–9 hours' },
  ...
  { week: 11, dates: 'Nov 2–8', title: 'Christian Perspective on AI', learn: 'Human dignity, truthfulness, justice and fairness, stewardship, responsibility, and moral discernment in AI-assisted decisions.', build: 'Add a Values-Based AI Decision Framework recording the situation, affected people, values, tensions, evidence, safeguards, and accountable decision.', test: 'Challenge whether the recommendation respects people, tells the truth about uncertainty, distributes benefits and burdens fairly, and preserves accountability.', manage: 'Use values to evaluate tradeoffs without reducing ethical judgment to slogans.', present: 'Defend a values-based recommendation and explain the tensions and safeguards involved.', output: 'Values-Based AI Decision Framework + decision memo', studentQuestion: 'What should guide a manager when an efficient AI choice conflicts with important values?', studentWin: 'Use a structured values framework to make a defensible AI management decision.', career: 'Bring ethical reasoning and accountability into technology-enabled decisions.', workload: '7–9 hours' },
  { week: 12, dates: 'Nov 9–15', title: 'AI and the Workforce', learn: 'Tasks versus jobs, automation, augmentation, human skills, worker voice, reskilling, and transition risk.', build: 'Add a Workforce Impact Map showing current tasks, AI opportunity, human-retained work, skills, training, risks, and management recommendations.', test: 'Check whether the plan distinguishes task change from job elimination and whether affected workers have realistic support and voice.', manage: 'Plan augmentation, reskilling, transition support, and safeguards for work that should remain human.', present: 'Defend which tasks AI may assist, which require human judgment, and what support workers need.', output: 'Workforce Impact Map + management recommendation', studentQuestion: 'How should a manager introduce AI without treating people as disposable?', studentWin: 'Plan AI-enabled work around tasks, human strengths, worker impact, and responsible transition.', career: 'Lead workforce change with clearer skill and transition planning.', workload: '8–10 hours' },
...
export default function Home() {
  ...
  const [quizSecondsById, setQuizSecondsById] = useState<Record<string, number>>({});
  ...
  const activeQuizId = selectedWeek === 10 && moduleItem?.startsWith('quiz-10-lesson-') ? moduleItem : null;
  const activeQuizSubmissionKey = activeQuizId ? {
    'quiz-10-lesson-1': 'week10-academic-integrity-submitted',
    'quiz-10-lesson-2': 'week10-support-substitution-submitted',
    'quiz-10-lesson-3': 'week10-attribution-submitted',
    'quiz-10-lesson-4': 'week10-disclosure-quality-submitted',
  }[activeQuizId] : undefined;
  const quizSecondsRemaining = activeQuizId ? quizSecondsById[activeQuizId] ?? 600 : 600;

  useEffect(() => {
    if (!activeQuizId) return;
    const timer = window.setInterval(() => {
      setQuizSecondsById((current) => ({ ...current, [activeQuizId]: Math.max(0, (current[activeQuizId] ?? 600) - 1) }));
    }, 1000);
  ...
  useEffect(() => {
    ...
    setStructuredAnswers((current) => current[activeQuizSubmissionKey] ? current : { ...current, [activeQuizSubmissionKey]: true });
  }, [activeQuizSubmissionKey, quizSecondsRemaining]);
  ...
  function renderStructuredWeek() {
    ...
    const lesson1AssignmentWordCount = lesson1AssignmentResponse.trim() ? lesson1AssignmentResponse.trim().split(/\s+/).length : 0;
    const typeLabel: Record<ModuleItem['type'], string> = { lesson: 'LEARN', practice: 'PRACTICE', case: 'APPLY', build: 'BUILD', assessment: 'ASSESS', quiz: `QUIZ · ${quizTimerLabel} remaining`, assignment: 'ASSIGNMENT', submit: 'SUBMIT', reflect: 'REFLECT', resource: 'RESOURCES', connect: 'CONNECT' };
    const lessonIndex = selectedItem?.id.startsWith('lesson-') ? Number(selectedItem.id.replace('lesson-', '')) - 1 : -1;
    const lessonData = selectedWeek === 6 ? ethicsLessons[lessonIndex] : selectedWeek === 7 ? governanceLessons[lessonIndex] : selectedWeek === 10 && lessonIndex === 3 ? [
      'Disclosure Quality',
      'AI Disclosure is a statement explaining when and how AI contributed to a piece of work. Disclosure Quality describes how clearly and completely the disclosure explains AI\'s role in the final work. A strong disclosure answers which AI tool was used, what it was used for, what AI contributed, and what the person reviewed, changed, or verified. Simply stating “I used AI” is not enough. Manager A writes, “I used AI for this report.” Manager B writes, “I used ChatGPT to help organize the report and summarize initial ideas. I reviewed the output, revised the recommendations, and verified important claims using the original sources.” Manager B provides the stronger disclosure because the contribution and human review are clear.',
      'Decision Prompt: Your team uses AI to brainstorm recommendations, organize data, and draft portions of a presentation for senior leadership. Include the AI tool used, tasks AI assisted with, content AI generated, changes the team made, how important information was verified, and who reviewed and approved the final work. Manager Takeaway: Good AI disclosure is more than simply saying “AI was used.” Make clear what AI contributed, what humans contributed, and who remains responsible for the final result. Checkpoint: Would someone reading my disclosure clearly understand how AI contributed to this work? Think About It: What details would you need to see in an AI disclosure before trusting AI-assisted work in a real organization?',
    ] : selectedWeek === 6 ? ethicsLessons[lessonIndex] : selectedWeek === 7 ? governanceLessons[lessonIndex] : selectedWeek === 10 && lessonIndex === 2 ? [
      'Attribution',
      'Responsible AI use requires transparency about where information comes from and how AI contributed to the final work. Attribution means clearly identifying where information, ideas, data, or other content came from instead of presenting someone else\'s contribution as your own. AI attribution means acknowledging when an AI tool meaningfully contributed to work and explaining how it was used when appropriate. Example: a manager uses AI to prepare a market analysis, checks its statistics against reliable sources, identifies the sources used, and explains that AI helped organize the analysis. Another manager copies the AI-generated analysis directly into a report without checking the information or acknowledging the AI assistance. Are both managers using AI responsibly? No. The first manager verifies the information and is transparent about how AI contributed; the second presents AI-generated material without verification or appropriate attribution.',
      'Decision Prompt: Your team uses AI to help create a report for senior leadership. Before presenting it, determine where the information originally came from, verify important claims, credit sources appropriately, decide whether significant AI assistance should be disclosed, and confirm who is responsible for the final content. Manager Takeaway: Using AI does not remove the responsibility to give credit, verify sources, and communicate honestly about how work was created. Checkpoint: Can I explain where this information came from and how AI contributed to the final work? Think About It: If AI helps create a report but you cannot verify where an important claim came from, should you use that claim? Why or why not?',
    ] : selectedWeek === 6 ? ethicsLessons[lessonIndex] : selectedWeek === 7 ? governanceLessons[lessonIndex] : selectedWeek === 10 && lessonIndex === 1 ? [
      'Support vs. Substitution',
      'Responsible AI use depends on whether AI is supporting human work or replacing human judgment. Support means AI assists a person while the person remains actively involved and responsible for the final result. Substitution means AI performs work or makes decisions that would otherwise require meaningful human thinking, judgment, or contribution. Example: a manager uses AI to summarize employee survey responses, reviews the original responses, checks the conclusions, and decides what actions to take. Another manager asks AI to analyze employee performance and automatically decide promotions without human review. Are both managers using AI appropriately? No. The first use supports the manager; the second substitutes for important human judgment and could affect employees without appropriate review.',
      'Decision Prompt: Your organization uses AI to recommend which job applicants should move to the interview stage. Before using the recommendations, review what information the AI used, whether the recommendation is accurate and relevant, whether bias could affect the result, who could be affected by an incorrect recommendation, and who makes the final decision. Manager Takeaway: AI can make work faster, but efficiency does not remove human responsibility. Checkpoint: Is AI helping me make the decision—or making the decision for me? Think About It: What evidence or human review would you require before using an AI recommendation in a real organization?',
    ] : selectedItem && selectedItem.type === 'lesson' ? [
      selectedItem.title.replace(/^Lesson \d+ · /, ''),
      `This lesson introduces ${selectedItem.title.replace(/^Lesson \d+ · /, '')} in the context of managing AI-enabled work.`,
      'Apply the concept to a real business problem, identify the manager’s responsibility, and explain what evidence or human review would still be needed.',
    ] : undefined;
    if (selectedItem) return <>
      ...
      {selectedWeek === 4 && selectedItem.type === 'lesson' && (() => {
        const lesson = week4Lessons[Number(selectedItem.id.replace('lesson-', '')) - 1];
        return <section className="lmsPanel structuredLesson"><div className="panelBar"><h3>{selectedItem.title}</h3><span>Week 4 · Lesson {Number(selectedItem.id.replace('lesson-', ''))}</span></div><p>{lesson[1]}</p><div className="lessonCallout"><strong>Manager takeaway</strong><span>{lesson[2]}</span></div><div className="lessonPrompt"><strong>Think about it</strong><span>Describe a real management task where AI would save time but still need human review before sending or acting on the result.</span></div></section>;
      })()}
      {selectedWeek === 4 && selectedItem.type === 'practice' && <section className="lmsPanel structuredLesson"><div className="panelBar"><h3>Practice Activity · AI Productivity Comparison</h3><span>Short case</span></div><p><strong>Management task:</strong> {week4PracticeTask}</p><div className="comparisonTable"><article><strong>Normal process</strong><span>Draft notes manually, gather decisions, rewrite the summary, compose the email, and review both documents before sending.</span></article><article><strong>AI-assisted process</strong><span>Use AI to summarize notes, list action items, draft the email, and produce a first-pass version that the manager then checks and revises.</span></article></div><div className="lessonCallout"><strong>Student analysis</strong><span>Compare the normal and AI-assisted process using time required, quality difference, possible risks, and human review needed. Explain which parts of the work are still better completed by a manager.</span></div><div className="moduleWorkPrompt"><strong>Activity response</strong><textarea value={String(structuredAnswers['week4-practice-response'] || '')} onChange={(event) => answerStructured('week4-practice-response', event.target.value)} placeholder="Normal process: ... AI-assisted process: ... Time required: ... Quality difference: ... Risks: ... Human review: ..." /></div><div className="decisionFeedback"><strong>Feedback pattern</strong><p>AI usually saves time on drafting, organizing, and summarizing. The manager still reviews the content for accuracy, confidentiality, tone, decision quality, and whether the message matches the team or audience.</p></div></section>}
      {selectedWeek === 4 && selectedItem.type === 'build' && <section className="lmsPanel structuredLesson"><div className="panelBar"><h3>AI Productivity</h3><span>Student assignment</span></div><p>Choose one management task and compare your normal process with an AI-assisted process. Keep the work realistic, practical, and grounded in a manager’s actual responsibility.</p><div className="lessonCallout"><strong>Worked example</strong><span>{week4WorkedExample.managementTask}</span></div><div className="comparisonTable"><article><strong>Management task</strong><span>{week4WorkedExample.managementTask}</span></article><article><strong>Normal process</strong><span>{week4WorkedExample.normalProcess}</span></article><article><strong>AI-assisted process</strong><span>{week4WorkedExample.aiAssistedProcess}</span></article><article><strong>Estimated normal time</strong><span>{week4WorkedExample.normalTime} minutes</span></article><article><strong>Estimated AI-assisted time</strong><span>{week4WorkedExample.aiAssistedTime} minutes</span></article><article><strong>Estimated time saved</strong><span>{week4WorkedExample.normalTime - week4WorkedExample.aiAssistedTime} minutes</span></article><article><strong>Quality change</strong><span>{week4WorkedExample.qualityChange}</span></article><article><strong>Risks</strong><span>{week4WorkedExample.risks}</span></article><article><strong>Human review required</strong><span>{week4WorkedExample.humanReviewRequired}</span></article></div><div className="lessonPrompt"><strong>Student directions</strong><ol><li>Choose a management task that you regularly handle, such as email, meeting notes, research, planning, or task coordination.</li><li>Describe the normal process in detail.</li><li>Explain how AI could assist with the task.</li><li>Compare the two approaches using time, quality, risks, and human review.</li><li>Estimate time saved and note any tradeoffs.</li><li>Record the results in the AI Productivity section of your dashboard.</li></ol></div><div className="assessmentFields"><label>Management Task<input value={String(structuredAnswers['week4-task'] || '')} onChange={(event) => answerStructured('week4-task', event.target.value)} placeholder="Example: prepare a weekly team meeting summary" /></label><label>Normal Process<textarea value={String(structuredAnswers['week4-normal-process'] || '')} onChange={(event) => answerStructured('week4-normal-process', event.target.value)} placeholder="Describe the full manual process." /></label><label>AI-Assisted Process<textarea value={String(structuredAnswers['week4-ai-process'] || '')} onChange={(event) => answerStructured('week4-ai-process', event.target.value)} placeholder="Describe how AI would help." /></label><label>Normal Time<input type="number" value={String(structuredAnswers['week4-normal-time'] ?? '')} onChange={(event) => answerStructured('week4-normal-time', Number(event.target.value) || 0)} placeholder="Minutes" /></label><label>AI-Assisted Time<input type="number" value={String(structuredAnswers['week4-ai-time'] ?? '')} onChange={(event) => answerStructured('week4-ai-time', Number(event.target.value) || 0)} placeholder="Minutes" /></label><label>Time Saved<input value={String((Number(structuredAnswers['week4-normal-time'] || 0) - Number(structuredAnswers['week4-ai-time'] || 0)) || '')} readOnly placeholder="Calculated automatically" /></label><label>Quality Change<textarea value={String(structuredAnswers['week4-quality'] || '')} onChange={(event) => answerStructured('week4-quality', event.target.value)} placeholder="Does AI improve speed, organization, or clarity?" /></label><label>Risks<textarea value={String(structuredAnswers['week4-risks'] || '')} onChange={(event) => answerStructured('week4-risks', event.target.value)} placeholder="Misstatements, missing context, privacy, tone, or quality issues." /></label><label>Human Review Needed<textarea value={String(structuredAnswers['week4-human-review'] || '')} onChange={(event) => answerStructured('week4-human-review', event.target.value)} placeholder="What still must be checked by the manager?" /></label></div></section>}
      {selectedWeek === 4 && selectedItem.type === 'assessment' && selectedItem.id === 'assessment-discussion-2' && <section className="lmsPanel structuredLesson"><div className="panelBar"><h3>Discussion 2</h3><span>Initial post 250–350 words · reply 100–150 words</span></div><p><strong>Question:</strong> “Should employees have to disclose when they use AI for emails, reports, presentations, research, or other work?”</p><p>Take a clear position and explain your reasoning. Include at least one benefit of AI disclosure, one problem or risk, when disclosure should or should not be required, and your response to a classmate. Use a realistic business example and make the final argument professional and specific.</p><div className="lessonCallout"><strong>Grading expectations</strong><span>Clear position, strong reasoning, specific example, one benefit and one risk, when disclosure is required, and one thoughtful reply to a classmate. The quality of the argument matters more than whether the answer is simple.</span></div><div className="moduleWorkPrompt"><strong>Private draft</strong><textarea value={String(discussionDraft || '')} onChange={(event) => setDiscussionDraft(event.target.value)} placeholder="Draft your discussion post here." /></div></section>}
      {selectedWeek === 4 && selectedItem.type === 'submit' && <section className="lmsPanel structuredLesson"><div className="panelBar"><h3>Week 4 Submission Checklist</h3><span>Complete all required items</span></div><ul><li>Week 4 lesson</li><li>Practice activity</li><li>AI Productivity assignment</li><li>Discussion 2</li><li>Week 4 reflection</li></ul><div className="lessonCallout"><strong>Simple rubric for AI Productivity</strong><span>{week4Rubric.map(([criterion, description]) => `${criterion}: ${description}`).join(' | ')}</span></div></section>}
      {selectedWeek === 4 && selectedItem.type === 'reflect' && <section className="lmsPanel structuredLesson"><div className="panelBar"><h3>Week 4 Reflection</h3><span>150–250 words</span></div><p>How did AI change your management task? Explain what became faster, what still required human judgment, and what a manager must review before relying on AI-generated work. Describe one situation where AI would be helpful and one situation where it should not be trusted without review.</p><textarea value={String(structuredAnswers['week4-reflection'] || '')} onChange={(event) => answerStructured('week4-reflection', event.target.value)} placeholder="Write a concise reflection on time saved, quality, risk, and human review." /></section>}
      {selectedWeek === 4 && selectedItem.type === 'resource' && <section className="lmsPanel structuredLesson"><div className="panelBar"><h3>Week 4 Resources</h3><span>Key terms and lesson map</span></div><div className="termGrid">{week4Terms.map(([term, definition]) => <article key={term}><strong>{term}</strong><p>{definition}</p></article>)}</div><div className="lessonCallout"><strong>Lesson agenda</strong><span>{week4Lessons.map(([title]) => title).join(' · ')}</span></div></section>}
      {selectedWeek === 5 && selectedItem.type === 'lesson' && (() => {
        const lesson = week5Lessons[lessonIndex];
        return <section className="lmsPanel structuredLesson"><div className="panelBar"><h3>{selectedItem.title}</h3><span>Week 5 · Lesson {lessonIndex + 1}</span></div><p>{lesson[1]}</p><div className="lessonCallout"><strong>Manager takeaway</strong><span>{lesson[2]}</span></div><div className="lessonPrompt"><strong>Think about it</strong><span>What information, alternative, or human review would you need before acting on an AI recommendation in this situation?</span></div></section>;
      })()}
      {selectedWeek === 5 && selectedItem.type === 'practice' && <section className="lmsPanel structuredLesson"><div className="panelBar"><h3>Practice Activity · Decision Support Check</h3><span>Analyze · compare · verify</span></div><p><strong>Scenario:</strong> {week5PracticeTask}</p><div className="caseReveal"><strong>Information available</strong><ul>{week5Case.available.map((item) => <li key={item}>{item}</li>)}</ul></div><div className="lessonCallout"><strong>Student analysis</strong><span>Record the information available, information missing, possible causes, an AI recommendation, alternative solutions, risks, information to verify, and what the manager should do next. Keep the AI recommendation separate from your own decision.</span></div><div className="moduleWorkPrompt"><strong>Practice response</strong><textarea value={String(structuredAnswers['week5-practice-response'] || '')} onChange={(event) => answerStructured('week5-practice-response', event.target.value)} placeholder="Available: ... Missing: ... Possible causes: ... AI recommendation: ... Alternatives: ... Risks: ... Verify: ... Next step: ..." /></div><div className="decisionFeedback"><strong>Feedback pattern</strong><p>The strongest response treats the AI output as a hypothesis, identifies unknowns, compares alternatives, verifies important claims, and keeps the manager responsible for the next action.</p></div></section>}
      {selectedWeek === 5 && selectedItem.type === 'case' && <section className="lmsPanel structuredLesson"><div className="panelBar"><h3>Employee Turnover Case</h3><span>Management case · 30–45 min</span></div><p><strong>Situation:</strong> A department has experienced increased employee turnover during the last six months. The manager asks AI to analyze the situation and recommend a response.</p><div className="comparisonTable"><article><strong>Information available</strong><ul>{week5Case.available.map((item) => <li key={item}>{item}</li>)}</ul></article><article><strong>Important information unknown</strong><ul>{week5Case.missing.map((item) => <li key={item}>{item}</li>)}</ul></article></div><div className="lessonCallout"><strong>Case question</strong><span>What should the manager do before making a major decision? Do not assume that the first plausible cause is the true cause.</span></div><div className="moduleWorkPrompt"><strong>Case response</strong><textarea value={String(structuredAnswers['week5-case-response'] || '')} onChange={(event) => answerStructured('week5-case-response', event.target.value)} placeholder="Information available; missing information; possible causes; recommendation; alternatives; risks; verification; next step" /></div><p className="smallNote">A strong response recognizes that more information is needed before a major compensation, staffing, or restructuring decision.</p></section>}
      {selectedWeek === 5 && selectedItem.type === 'build' && <section className="lmsPanel structuredLesson"><div className="panelBar"><h3>Manager Decision Assistant</h3><span>Student assignment · saved on this device</span></div><p>Use this assistant to document how AI supports a management decision. You may use AI outside this dashboard to generate an analysis and recommendation, but do not include confidential or personal information. Your final decision must be your own accountable judgment.</p><div className="lessonCallout"><strong>Required separation</strong><span>AI RECOMMENDATION is an input. MANAGER&apos;S FINAL DECISION is the accountable decision. They must not be treated as the same field.</span></div><div className="assessmentFields"><label className="fullField">Management Problem<textarea value={String(structuredAnswers['week5-management-problem'] || '')} onChange={(event) => answerStructured('week5-management-problem', event.target.value)} placeholder="What management problem needs a decision?" /></label><label className="fullField">Information Available<textarea value={String(structuredAnswers['week5-information-available'] || '')} onChange={(event) => answerStructured('week5-information-available', event.target.value)} placeholder="What facts, data, and context do you have?" /></label><label className="fullField">AI Analysis<textarea value={String(structuredAnswers['week5-ai-analysis'] || '')} onChange={(event) => answerStructured('week5-ai-analysis', event.target.value)} placeholder="What patterns, summaries, or possible causes did AI identify?" /></label><label className="fullField">AI Recommendation<textarea value={String(structuredAnswers['week5-ai-recommendation'] || '')} onChange={(event) => answerStructured('week5-ai-recommendation', event.target.value)} placeholder="What did AI suggest? Label this as a recommendation, not a decision." /></label><label className="fullField">Alternative Solutions<textarea value={String(structuredAnswers['week5-alternative-solutions'] || '')} onChange={(event) => answerStructured('week5-alternative-solutions', event.target.value)} placeholder="What other realistic options did you consider? Compare tradeoffs." /></label><label className="fullField">Missing Information<textarea value={String(structuredAnswers['week5-missing-information'] || '')} onChange={(event) => answerStructured('week5-missing-information', event.target.value)} placeholder="What does AI not know that could change the decision?" /></label><label className="fullField">Information to Verify<textarea value={String(structuredAnswers['week5-information-to-verify'] || '')} onChange={(event) => answerStructured('week5-information-to-verify', event.target.value)} placeholder="What sources, calculations, assumptions, or stakeholder feedback will you check?" /></label><label className="fullField">Risks<textarea value={String(structuredAnswers['week5-risks'] || '')} onChange={(event) => answerStructured('week5-risks', event.target.value)} placeholder="What could happen if the recommendation or decision is incomplete or wrong?" /></label><label className="fullField managerDecisionField"><strong>Manager&apos;s Final Decision</strong><textarea value={String(structuredAnswers['week5-final-decision'] || '')} onChange={(event) => answerStructured('week5-final-decision', event.target.value)} placeholder="What will you decide or do next? You may accept, change, delay, or reject the AI recommendation." /></label><label className="fullField managerDecisionField"><strong>Reason for Final Decision</strong><textarea value={String(structuredAnswers['week5-final-reason'] || '')} onChange={(event) => answerStructured('week5-final-reason', event.target.value)} placeholder="Explain how evidence, alternatives, missing information, verification, and risk shaped your decision." /></label></div><div className="formActions"><button type="button" onClick={() => { setSaveNotice('Manager Decision Assistant saved on this device.'); window.setTimeout(() => setSaveNotice(''), 2200); }}>{saveNotice || 'Save draft'}</button><button className="primaryAction" type="button" onClick={() => completeModuleItem(selectedItem.id)}>Save and mark complete</button></div></section>}
      {selectedWeek === 5 && selectedItem.type === 'assessment' && selectedItem.id === 'assessment-quiz-2' && <section className="lmsPanel structuredLesson"><div className="panelBar"><h3>Quiz 2 — Prompting, Productivity, and Managerial Decision Support</h3><span>{structuredAnswers['week5-quiz2-submitted'] ? `${quiz2Questions.filter((question, index) => structuredAnswers[`week5-quiz2-${index}`] === question.answer).length} / ${quiz2Questions.length} correct` : `${quiz2Questions.length} multiple-choice questions`}</span></div><p>Choose one answer for each question. Quiz 2 covers Weeks 3–5. Your score and answer explanations appear only after you submit.</p>{quiz2Questions.map((question, index) => <fieldset className="knowledgeItem" key={question.question}><legend>{index + 1}. {question.question}</legend>{question.options.map((option, optionIndex) => <label className="choiceLabel" key={option}><input type="radio" name={`week5-quiz2-${index}`} checked={structuredAnswers[`week5-quiz2-${index}`] === optionIndex} disabled={Boolean(structuredAnswers['week5-quiz2-submitted'])} onChange={() => answerStructured(`week5-quiz2-${index}`, optionIndex)} />{option}</label>)}{structuredAnswers['week5-quiz2-submitted'] && <p className={structuredAnswers[`week5-quiz2-${index}`] === question.answer ? 'feedbackCorrect' : 'feedback'}>{structuredAnswers[`week5-quiz2-${index}`] === question.answer ? 'Correct. ' : 'Review. '}{question.explanation}</p>}</fieldset>)}<div className="formActions"><button className="primaryAction" type="button" disabled={Boolean(structuredAnswers['week5-quiz2-submitted']) || quiz2Questions.some((_, index) => typeof structuredAnswers[`week5-quiz2-${index}`] !== 'number')} onClick={() => answerStructured('week5-quiz2-submitted', true)}>{structuredAnswers['week5-quiz2-submitted'] ? 'Quiz submitted' : 'Submit Quiz 2'}</button>{structuredAnswers['week5-quiz2-submitted'] && <p><strong>Score:</strong> {Math.round(quiz2Questions.filter((question, index) => structuredAnswers[`week5-quiz2-${index}`] === question.answer).length / quiz2Questions.length * 100)}%. Review each explanation and revisit any missed concept before moving on.</p>}</div></section>}
      {selectedWeek === 5 && selectedItem.type === 'submit' && <section className="lmsPanel structuredLesson"><div className="panelBar"><h3>Week 5 Submission Checklist</h3><span>Complete all required items</span></div><ul><li>Week 5 lesson</li><li>Practice activity</li><li>Employee turnover case</li><li>Manager Decision Assistant</li><li>Quiz 2</li><li>Week 5 reflection</li></ul><div className="lessonCallout"><strong>Manager Decision Assistant rubric</strong><span>{week5Rubric.map(([criterion, description]) => `${criterion}: ${description}`).join(' | ')}</span></div></section>}
      {selectedWeek === 5 && selectedItem.type === 'reflect' && <section className="lmsPanel structuredLesson"><div className="panelBar"><h3>Week 5 Reflection</h3><span>150–250 words</span></div><p>Describe a time when a manager should question an AI recommendation. Explain what information should be verified, what alternative solutions should be considered, and why the manager remains accountable for the final decision.</p><textarea value={String(structuredAnswers['week5-reflection'] || '')} onChange={(event) => answerStructured('week5-reflection', event.target.value)} placeholder="Explain how you would keep AI in a decision-support role while preserving managerial judgment." /></section>}
      {selectedWeek === 5 && selectedItem.type === 'resource' && <section className="lmsPanel structuredLesson"><div className="panelBar"><h3>Week 5 Resources and Completed Example</h3><span>Use the model to inspect the decision process</span></div><div className="termGrid">{week5Terms.map(([term, definition]) => <article key={term}><strong>{term}</strong><p>{definition}</p></article>)}</div><div className="lessonCallout"><strong>Central message</strong><span>AI RECOMMENDS. MANAGERS DECIDE.</span></div><h4>Completed example · Employee turnover</h4><div className="comparisonTable"><article><strong>AI Analysis</strong><span>{week5Case.aiAnalysis}</span></article><article><strong>AI Recommendation</strong><span>{week5Case.aiRecommendation}</span></article><article><strong>Alternative Solutions</strong><span>{week5Case.alternatives.join(' ')}</span></article><article><strong>Missing Information</strong><span>{week5Case.missing.join(' ')}</span></article><article><strong>Risks</strong><span>{week5Case.risks}</span></article></div><div className="decisionFeedback"><strong>MANAGER&apos;S FINAL DECISION</strong><p>{week5Case.decision}</p><strong>Reason for the decision</strong><p>{week5Case.reason}</p></div></section>}
      {selectedWeek !== 5 && selectedItem.type === 'lesson' && <>
        {selectedWeek === 10 && lessonIndex === 0 ? <section className="lmsPanel structuredLesson"><div className="panelBar"><h3>Know · Understand · Apply</h3><span>Lesson {lessonIndex + 1}</span></div><div className="knowGrid"><article><strong>KNOW</strong><p>Key vocabulary: Academic Integrity, Plagiarism, Original Work, Attribution, and AI Disclosure.<br /><br />Academic integrity means completing work honestly, responsibly, and transparently. When using AI, students are still responsible for ensuring that submitted work reflects their own thinking and follows course expectations.</p></article><article><strong>UNDERSTAND</strong><p><strong>Concept:</strong> Using AI does not automatically violate academic integrity. The concern is <strong>how AI is used and represented</strong>.<br /><br /><strong>Student example:</strong> A student writes an assignment independently and uses AI to check grammar. Another student asks AI to write the entire assignment and submits it as their own.<br /><br /><strong>Student decision:</strong> Are both students using AI appropriately?<br /><br /><strong>Feedback:</strong> No. AI can support a student&apos;s work, but it should not replace the student&apos;s thinking or contribution. Significant AI assistance should also be disclosed when required.</p></article><article><strong>APPLY</strong><p><strong>Decision prompt:</strong> A student uses AI to generate two paragraphs of an assignment, changes several words, and submits the work without disclosing the AI use. Does this demonstrate academic integrity? Explain why or why not and describe what the student should have done differently.<br /><br /><strong>Expected answer:</strong> No. This does not demonstrate academic integrity because the student relied on AI to generate substantial content, revised only a few words, and submitted the work without disclosure. The student should have disclosed the AI assistance if the assignment required it, significantly revised the AI-generated content, and made sure the final work reflects their own thinking, analysis, and writing.</p></article></div></section> : <section className="lmsPanel structuredLesson"><div className="panelBar"><h3>Know · Understand · Apply</h3><span>Lesson {lessonIndex + 1}</span></div><div className="knowGrid"><article><strong>KNOW</strong><p>Key vocabulary: {selectedItem.title.replace(/^Lesson \d+ · /, '')} and its relationship to responsible management.</p></article><article><strong>UNDERSTAND</strong><p>{lessonData?.[1] || selectedItem.description}</p></article><article><strong>APPLY</strong><p>{lessonData?.[2] || 'Name the owner, affected stakeholders, evidence, and safeguard for a realistic management use case.'}</p></article></div></section>}
      ...
      {selectedWeek === 11 && selectedItem.type === 'quiz' && selectedItem.id === 'quiz-11-lesson-1' && (() => {
        const submitted = Boolean(structuredAnswers['week11-human-dignity-submitted']);
        const answered = humanDignityQuestions.filter((_, index) => typeof structuredAnswers[`week11-human-dignity-${index}`] === 'number').length;
        const score = humanDignityQuestions.filter((question, index) => structuredAnswers[`week11-human-dignity-${index}`] === question.answer).length;
        return <section className="lmsPanel structuredLesson"><div className="panelBar"><h3>Lesson 1 Quiz: Human Dignity in AI-Enabled Work</h3><span>{submitted ? `${score} / ${humanDignityQuestions.length} correct` : `${answered} of ${humanDignityQuestions.length} answered`}</span></div><p>Choose the best answer for each question. Your score and explanations appear after submission.</p>{humanDignityQuestions.map((question, index) => <fieldset className="knowledgeItem" key={question.question}><legend>{index + 1}. {question.question}</legend>{question.options.map((option, optionIndex) => <label className="choiceLabel" key={option}><input type="radio" name={`week11-human-dignity-${index}`} checked={structuredAnswers[`week11-human-dignity-${index}`] === optionIndex} disabled={submitted} onChange={() => answerStructured(`week11-human-dignity-${index}`, optionIndex)} />{String.fromCharCode(65 + optionIndex)}. {option}</label>)}{submitted && <p className={structuredAnswers[`week11-human-dignity-${index}`] === question.answer ? 'feedbackCorrect' : 'feedback'}>{structuredAnswers[`week11-human-dignity-${index}`] === question.answer ? 'Correct. ' : 'Review. '}{question.explanation}</p>}</fieldset>)}{submitted && <div className={score >= 4 ? 'decisionFeedback' : 'feedback'}><strong>Score: {score}/{humanDignityQuestions.length}</strong><p>4/5 required to complete Lesson 1</p></div>}<div className="formActions"><button className="primaryAction" type="button" disabled={submitted || answered < humanDignityQuestions.length} onClick={() => answerStructured('week11-human-dignity-submitted', true)}>{submitted ? 'Quiz submitted' : 'Submit quiz'}</button></div></section>;
      })()}
      {selectedWeek === 11 && selectedItem.type === 'quiz' && selectedItem.id === 'quiz-11-lesson-2' && (() => {
        const submitted = Boolean(structuredAnswers['week11-truthfulness-submitted']);
        const answered = truthfulnessQuestions.filter((_, index) => typeof structuredAnswers[`week11-truthfulness-${index}`] === 'number').length;
        const score = truthfulnessQuestions.filter((question, index) => structuredAnswers[`week11-truthfulness-${index}`] === question.answer).length;
        return <section className="lmsPanel structuredLesson"><div className="panelBar"><h3>Lesson 2 Quiz: Truthfulness in AI-Enabled Work</h3><span>{submitted ? `${score} / ${truthfulnessQuestions.length} correct` : `${answered} of ${truthfulnessQuestions.length} answered`}</span></div><p>Choose the best answer for each question. Your score and explanations appear after submission.</p>{truthfulnessQuestions.map((question, index) => <fieldset className="knowledgeItem" key={question.question}><legend>{index + 1}. {question.question}</legend>{question.options.map((option, optionIndex) => <label className="choiceLabel" key={option}><input type="radio" name={`week11-truthfulness-${index}`} checked={structuredAnswers[`week11-truthfulness-${index}`] === optionIndex} disabled={submitted} onChange={() => answerStructured(`week11-truthfulness-${index}`, optionIndex)} />{String.fromCharCode(65 + optionIndex)}. {option}</label>)}{submitted && <p className={structuredAnswers[`week11-truthfulness-${index}`] === question.answer ? 'feedbackCorrect' : 'feedback'}>{structuredAnswers[`week11-truthfulness-${index}`] === question.answer ? 'Correct. ' : 'Review. '}{question.explanation}</p>}</fieldset>)}{submitted && <div className={score >= 4 ? 'decisionFeedback' : 'feedback'}><strong>Score: {score}/{truthfulnessQuestions.length}</strong><p>4/5 required to complete Lesson 2</p></div>}<div className="formActions"><button className="primaryAction" type="button" disabled={submitted || answered < truthfulnessQuestions.length} onClick={() => answerStructured('week11-truthfulness-submitted', true)}>{submitted ? 'Quiz submitted' : 'Submit quiz'}</button></div></section>;
      })()}
      {selectedWeek === 11 && selectedItem.type === 'quiz' && selectedItem.id === 'quiz-11-lesson-3' && (() => {
        const submitted = Boolean(structuredAnswers['week11-justice-fairness-submitted']);
        const answered = justiceFairnessQuestions.filter((_, index) => typeof structuredAnswers[`week11-justice-fairness-${index}`] === 'number').length;
        const score = justiceFairnessQuestions.filter((question, index) => structuredAnswers[`week11-justice-fairness-${index}`] === question.answer).length;
        return <section className="lmsPanel structuredLesson"><div className="panelBar"><h3>Lesson 3 Quiz: Justice and Fairness in AI-Enabled Work</h3><span>{submitted ? `${score} / ${justiceFairnessQuestions.length} correct` : `${answered} of ${justiceFairnessQuestions.length} answered`}</span></div><p>Choose the best answer for each question. Your score and explanations appear after submission.</p>{justiceFairnessQuestions.map((question, index) => <fieldset className="knowledgeItem" key={question.question}><legend>{index + 1}. {question.question}</legend>{question.options.map((option, optionIndex) => <label className="choiceLabel" key={option}><input type="radio" name={`week11-justice-fairness-${index}`} checked={structuredAnswers[`week11-justice-fairness-${index}`] === optionIndex} disabled={submitted} onChange={() => answerStructured(`week11-justice-fairness-${index}`, optionIndex)} />{String.fromCharCode(65 + optionIndex)}. {option}</label>)}{submitted && <p className={structuredAnswers[`week11-justice-fairness-${index}`] === question.answer ? 'feedbackCorrect' : 'feedback'}>{structuredAnswers[`week11-justice-fairness-${index}`] === question.answer ? 'Correct. ' : 'Review. '}{question.explanation}</p>}</fieldset>)}{submitted && <div className={score >= 4 ? 'decisionFeedback' : 'feedback'}><strong>Score: {score}/{justiceFairnessQuestions.length}</strong><p>4/5 required to complete Lesson 3</p></div>}<div className="formActions"><button className="primaryAction" type="button" disabled={submitted || answered < justiceFairnessQuestions.length} onClick={() => answerStructured('week11-justice-fairness-submitted', true)}>{submitted ? 'Quiz submitted' : 'Submit quiz'}</button></div></section>;
      })()}
      {selectedWeek === 11 && selectedItem.type === 'quiz' && selectedItem.id === 'quiz-11-lesson-4' && (() => {
        const submitted = Boolean(structuredAnswers['week11-stewardship-submitted']);
        const answered = stewardshipQuestions.filter((_, index) => typeof structuredAnswers[`week11-stewardship-${index}`] === 'number').length;
        const score = stewardshipQuestions.filter((question, index) => structuredAnswers[`week11-stewardship-${index}`] === question.answer).length;
        return <section className="lmsPanel structuredLesson"><div className="panelBar"><h3>Lesson 4 Quiz: Stewardship in AI-Enabled Work</h3><span>{submitted ? `${score} / ${stewardshipQuestions.length} correct` : `${answered} of ${stewardshipQuestions.length} answered`}</span></div><p>Choose the best answer for each question. Your score and explanations appear after submission.</p>{stewardshipQuestions.map((question, index) => <fieldset className="knowledgeItem" key={question.question}><legend>{index + 1}. {question.question}</legend>{question.options.map((option, optionIndex) => <label className="choiceLabel" key={option}><input type="radio" name={`week11-stewardship-${index}`} checked={structuredAnswers[`week11-stewardship-${index}`] === optionIndex} disabled={submitted} onChange={() => answerStructured(`week11-stewardship-${index}`, optionIndex)} />{String.fromCharCode(65 + optionIndex)}. {option}</label>)}{submitted && <p className={structuredAnswers[`week11-stewardship-${index}`] === question.answer ? 'feedbackCorrect' : 'feedback'}>{structuredAnswers[`week11-stewardship-${index}`] === question.answer ? 'Correct. ' : 'Review. '}{question.explanation}</p>}</fieldset>)}{submitted && <div className={score >= 4 ? 'decisionFeedback' : 'feedback'}><strong>Score: {score}/{stewardshipQuestions.length}</strong><p>4/5 required to complete Lesson 4</p></div>}<div className="formActions"><button className="primaryAction" type="button" disabled={submitted || answered < stewardshipQuestions.length} onClick={() => answerStructured('week11-stewardship-submitted', true)}>{submitted ? 'Quiz submitted' : 'Submit quiz'}</button></div></section>;
      })()}
      {selectedWeek === 10 && selectedItem.type === 'quiz' && selectedItem.id === 'quiz-10-lesson-1' && (() => {
        const submitted = quizExpired || Boolean(structuredAnswers['week10-academic-integrity-submitted']);
        const answered = academicIntegrityQuestions.filter((_, index) => typeof structuredAnswers[`week10-academic-integrity-${index}`] === 'number').length;
        const score = academicIntegrityQuestions.filter((question, index) => structuredAnswers[`week10-academic-integrity-${index}`] === question.answer).length;
        return <section className="lmsPanel structuredLesson"><div className="panelBar"><h3>Lesson 1: Academic Integrity</h3><span>{submitted ? `${score} / ${academicIntegrityQuestions.length} correct` : `${answered} of ${academicIntegrityQuestions.length} answered`}</span></div><p>Answer all five questions. Your score and feedback appear after you submit.</p>{academicIntegrityQuestions.map((question, index) => <fieldset className="knowledgeItem" key={question.question}><legend>{index + 1}. {question.question}</legend>{question.options.map((option, optionIndex) => <label className="choiceLabel" key={option}><input type="radio" name={`week10-academic-integrity-${index}`} checked={structuredAnswers[`week10-academic-integrity-${index}`] === optionIndex} disabled={submitted} onChange={() => answerStructured(`week10-academic-integrity-${index}`, optionIndex)} />{String.fromCharCode(65 + optionIndex)}. {option}</label>)}{submitted && <p className={structuredAnswers[`week10-academic-integrity-${index}`] === question.answer ? 'feedbackCorrect' : 'feedback'}>{structuredAnswers[`week10-academic-integrity-${index}`] === question.answer ? 'Correct. ' : 'Review. '}{question.explanation}</p>}</fieldset>)}{submitted && <div className={score >= 4 ? 'decisionFeedback' : 'feedback'}><strong>Score: {score}/{academicIntegrityQuestions.length}</strong><p>4/5 required to complete Lesson 1</p></div>}<div className="formActions"><button className="primaryAction" type="button" disabled={submitted || answered < academicIntegrityQuestions.length} onClick={() => answerStructured('week10-academic-integrity-submitted', true)}>{submitted ? 'Quiz submitted' : 'Submit quiz'}</button></div></section>;
      })()}
      {selectedWeek === 10 && selectedItem.type === 'quiz' && selectedItem.id === 'quiz-10-lesson-2' && (() => {
        const submitted = quizExpired || Boolean(structuredAnswers['week10-support-substitution-submitted']);
        const answered = supportSubstitutionQuestions.filter((_, index) => typeof structuredAnswers[`week10-support-substitution-${index}`] === 'number').length;
        const score = supportSubstitutionQuestions.filter((question, index) => structuredAnswers[`week10-support-substitution-${index}`] === question.answer).length;
        return <section className="lmsPanel structuredLesson"><div className="panelBar"><h3>Lesson 2: Support vs. Substitution Quiz</h3><span>{submitted ? `${score} / ${supportSubstitutionQuestions.length} correct` : `${answered} of ${supportSubstitutionQuestions.length} answered`}</span></div><p>Answer all five questions. Your score and feedback appear after you submit.</p>{supportSubstitutionQuestions.map((question, index) => <fieldset className="knowledgeItem" key={question.question}><legend>{index + 1}. {question.question}</legend>{question.options.map((option, optionIndex) => <label className="choiceLabel" key={option}><input type="radio" name={`week10-support-substitution-${index}`} checked={structuredAnswers[`week10-support-substitution-${index}`] === optionIndex} disabled={submitted} onChange={() => answerStructured(`week10-support-substitution-${index}`, optionIndex)} />{String.fromCharCode(65 + optionIndex)}. {option}</label>)}{submitted && <p className={structuredAnswers[`week10-support-substitution-${index}`] === question.answer ? 'feedbackCorrect' : 'feedback'}>{structuredAnswers[`week10-support-substitution-${index}`] === question.answer ? 'Correct. ' : 'Review. '}{question.explanation}</p>}</fieldset>)}{submitted && <div className={score >= 4 ? 'decisionFeedback' : 'feedback'}><strong>Score: {score}/{supportSubstitutionQuestions.length}</strong><p>4/5 required to complete Lesson 2</p></div>}<div className="formActions"><button className="primaryAction" type="button" disabled={submitted || answered < supportSubstitutionQuestions.length} onClick={() => answerStructured('week10-support-substitution-submitted', true)}>{submitted ? 'Quiz submitted' : 'Submit quiz'}</button></div></section>;
      })()}
      {selectedWeek === 10 && selectedItem.type === 'quiz' && selectedItem.id === 'quiz-10-lesson-3' && (() => {
        const submitted = quizExpired || Boolean(structuredAnswers['week10-attribution-submitted']);
        const answered = attributionQuestions.filter((_, index) => typeof structuredAnswers[`week10-attribution-${index}`] === 'number').length;
        const score = attributionQuestions.filter((question, index) => structuredAnswers[`week10-attribution-${index}`] === question.answer).length;
        return <section className="lmsPanel structuredLesson"><div className="panelBar"><h3>Lesson 3: Attribution Quiz</h3><span>{submitted ? `${score} / ${attributionQuestions.length} correct` : `${answered} of ${attributionQuestions.length} answered`}</span></div><p>Answer all five questions. Your score and feedback appear after you submit.</p>{attributionQuestions.map((question, index) => <fieldset className="knowledgeItem" key={question.question}><legend>{index + 1}. {question.question}</legend>{question.options.map((option, optionIndex) => <label className="choiceLabel" key={option}><input type="radio" name={`week10-attribution-${index}`} checked={structuredAnswers[`week10-attribution-${index}`] === optionIndex} disabled={submitted} onChange={() => answerStructured(`week10-attribution-${index}`, optionIndex)} />{String.fromCharCode(65 + optionIndex)}. {option}</label>)}{submitted && <p className={structuredAnswers[`week10-attribution-${index}`] === question.answer ? 'feedbackCorrect' : 'feedback'}>{structuredAnswers[`week10-attribution-${index}`] === question.answer ? 'Correct. ' : 'Review. '}{question.explanation}</p>}</fieldset>)}{submitted && <div className={score >= 4 ? 'decisionFeedback' : 'feedback'}><strong>Score: {score}/{attributionQuestions.length}</strong><p>4/5 required to complete Lesson 3</p></div>}<div className="formActions"><button className="primaryAction" type="button" disabled={submitted || answered < attributionQuestions.length} onClick={() => answerStructured('week10-attribution-submitted', true)}>{submitted ? 'Quiz submitted' : 'Submit quiz'}</button></div></section>;
      })()}
      {selectedWeek === 10 && selectedItem.type === 'quiz' && selectedItem.id === 'quiz-10-lesson-4' && (() => {
        const submitted = quizExpired || Boolean(structuredAnswers['week10-disclosure-quality-submitted']);
        const answered = disclosureQualityQuestions.filter((_, index) => typeof structuredAnswers[`week10-disclosure-quality-${index}`] === 'number').length;
        const score = disclosureQualityQuestions.filter((question, index) => structuredAnswers[`week10-disclosure-quality-${index}`] === question.answer).length;
        return <section className="lmsPanel structuredLesson"><div className="panelBar"><h3>Lesson 4: Disclosure Quality Quiz</h3><span>{submitted ? `${score} / ${disclosureQualityQuestions.length} correct` : `${answered} of ${disclosureQualityQuestions.length} answered`}</span></div><p>Answer all five questions. Your score and feedback appear after you submit.</p>{disclosureQualityQuestions.map((question, index) => <fieldset className="knowledgeItem" key={question.question}><legend>{index + 1}. {question.question}</legend>{question.options.map((option, optionIndex) => <label className="choiceLabel" key={option}><input type="radio" name={`week10-disclosure-quality-${index}`} checked={structuredAnswers[`week10-disclosure-quality-${index}`] === optionIndex} disabled={submitted} onChange={() => answerStructured(`week10-disclosure-quality-${index}`, optionIndex)} />{String.fromCharCode(65 + optionIndex)}. {option}</label>)}{submitted && <p className={structuredAnswers[`week10-disclosure-quality-${index}`] === question.answer ? 'feedbackCorrect' : 'feedback'}>{structuredAnswers[`week10-disclosure-quality-${index}`] === question.answer ? 'Correct. ' : 'Review. '}{question.explanation}</p>}</fieldset>)}{submitted && <div className={score >= 4 ? 'decisionFeedback' : 'feedback'}><strong>Score: {score}/{disclosureQualityQuestions.length}</strong><p>4/5 required to complete Lesson 4</p></div>}<div className="formActions"><button className="primaryAction" type="button" disabled={submitted || answered < disclosureQualityQuestions.length} onClick={() => answerStructured('week10-disclosure-quality-submitted', true)}>{submitted ? 'Quiz submitted' : 'Submit quiz'}</button></div></section>;
      })()}
      {selectedWeek === 10 && selectedItem.type === 'assignment' && selectedItem.id === 'assignment-10-lesson-1' && <section className="lmsPanel structuredLesson"><div className="panelBar"><h3>Assignment Folder · Academic Integrity Decision</h3><span>{lesson1AssignmentWordCount} / 100–150 words</span></div><p><strong>Purpose:</strong> Apply what you learned about academic integrity and responsible AI use to a realistic student situation.</p><div className="lessonCallout"><strong>Scenario</strong><span>A student uses AI to generate two paragraphs of an assignment. The student changes several words and submits the work without disclosing the AI use.</span></div><div className="lessonGrid"><h4>Your Task</h4><ol><li>Does this demonstrate academic integrity? Why or why not?</li><li>What should the student have done differently?</li><li>Identify one way AI could have been used more responsibly.</li></ol><p><strong>Requirements:</strong> Write 100–150 words. Clearly explain your decision, use at least one Lesson 1 concept, and explain how the student could improve their AI use.</p><p><strong>Concepts:</strong> Academic integrity, original work, transparency, or AI disclosure.</p></div><textarea value={lesson1AssignmentResponse} onChange={(event) => answerStructured('week10-lesson1-assignment-response', event.target.value)} placeholder="Write your 100–150 word response here." /><div className="decisionFeedback"><strong>Grading · 10 points</strong><p>Academic Integrity Decision: 4 · Responsible AI Recommendation: 3 · Lesson Concept: 2 · Clarity: 1</p></div></section>}
      {selectedWeek === 10 && selectedItem.type === 'assignment' && selectedItem.id !== 'assignment-10-lesson-1' && (() => {
        const lessonNumber = selectedItem.id.replace('assignment-10-lesson-', '');
        const responseKey = `week10-lesson${lessonNumber}-assignment-response`;
        const assignmentDetails: Record<string, { prompt: string; requirements: string; concepts: string }> = {
          '2': {
            prompt: 'A manager wants AI to automatically decide which applicants move to interviews. Explain whether this supports the manager or substitutes for meaningful human judgment.',
            requirements: 'Describe the boundary between support and substitution, identify two risks, and recommend a human review or safeguard.',
            concepts: 'Support, substitution, human judgment, oversight, or accountability.',
          },
          '3': {
            prompt: 'A team uses AI to draft a report for senior leadership, but one important claim has no traceable source. Explain what the team should do before presenting it.',
            requirements: 'Explain how to trace the claim, verify it, credit sources, and disclose meaningful AI assistance.',
            concepts: 'Attribution, verification, source quality, transparency, or accountability.',
          },
          '4': {
        ...
        return <section className="lmsPanel structuredLesson"><div className="panelBar"><h3>{selectedItem.title}</h3><span>Lesson {lessonNumber} assignment</span></div><p><strong>Scenario:</strong> {details.prompt}</p><div className="lessonGrid"><h4>Your Task</h4><p>{details.requirements}</p><p><strong>Concepts:</strong> {details.concepts}</p></div><textarea value={String(structuredAnswers[responseKey] || '')} onChange={(event) => answerStructured(responseKey, event.target.value)} placeholder="Write your response here." /><div className="decisionFeedback"><strong>Grading · 10 points</strong><p>Application: 4 · Reasoning: 3 · Lesson concept: 2 · Clarity: 1</p></div></section>;
      })()}
      {selectedItem.type === 'assessment' && selectedWeek === 1 && (() => {
        const submitted = Boolean(structuredAnswers['week1-knowledge-submitted']);
        const answered = lesson1KnowledgeQuestions.filter((_, index) => typeof structuredAnswers[`week1-knowledge-${index}`] === 'number').length;
        const score = lesson1KnowledgeQuestions.filter((question, index) => structuredAnswers[`week1-knowledge-${index}`] === question.answer).length;
        return <section className="lmsPanel structuredLesson"><div className="panelBar"><h3>Take the Lesson 1 Knowledge Check</h3><span>{submitted ? `${score} / ${lesson1KnowledgeQuestions.length} correct` : `${answered} of ${lesson1KnowledgeQuestions.length} answered`}</span></div><p>Answer all five questions. Your score and feedback appear after you submit.</p>{lesson1KnowledgeQuestions.map((question, index) => <fieldset className="knowledgeItem" key={question.question}><legend>{index + 1}. {question.question}</legend>{question.options.map((option, optionIndex) => <label className="choiceLabel" key={option}><input type="radio" name={`week1-knowledge-${index}`} checked={structuredAnswers[`week1-knowledge-${index}`] === optionIndex} disabled={submitted} onChange={() => answerStructured(`week1-knowledge-${index}`, optionIndex)} />{option}</label>)}{submitted && <p className={structuredAnswers[`week1-knowledge-${index}`] === question.answer ? 'feedbackCorrect' : 'feedback'}>{structuredAnswers[`week1-knowledge-${index}`] === question.answer ? 'Correct. ' : 'Review. '}{question.explanation}</p>}</fieldset>)}{submitted && <div className={score >= 4 ? 'decisionFeedback' : 'feedback'}><strong>Score: {score}/{lesson1KnowledgeQuestions.length}</strong><p>4/5 required to complete Lesson 1</p></div>}<div className="formActions"><button className="primaryAction" type="button" disabled={submitted || answered < lesson1KnowledgeQuestions.length} onClick={() => answerStructured('week1-knowledge-submitted', true)}>{submitted ? 'Knowledge check submitted' : 'Submit knowledge check'}</button></div></section>;
      })()}
            ...
            <div className="homeView">
              ...
              <div className="homeColumns">
                ...
                <aside className="rightColumn">
                  ...
                  <section className="lmsPanel currentModule"><div className="panelBar"><h3>Current Module</h3></div><span>Week {selectedWeek} · {activeWeek.dates}</span><h4>{activeWeek.title}</h4><p><strong>By Friday, I can:</strong> {activeWeek.studentWin}</p><dl><div><dt>Estimated work</dt><dd>{activeWeek.workload}</dd></div><div><dt>Submit</dt><dd>{activeWeek.output}</dd></div></dl><button type="button" onClick={() => switchView('content')}>Continue module →</button><button type="button" style={{ marginTop: '0.75rem' }} onClick={() => { setSelectedWeek(2); switchView('content'); }}>Open Week 2 · Deploy & Use →</button></section>
