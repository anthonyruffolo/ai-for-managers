...
const standardModule = (week: number, overview: string, objectives: string[], artifact: string, buildDescription: string, lessons: string[], practice: string, assessment: string, submission: string) => ({
  ...
  items: [
    ...
    ...(week === 10 ? [{ id: 'quiz-10-lesson-1', title: 'Quiz · Lesson 1: Academic Integrity', description: 'Check your understanding of honest AI use, support versus substitution, disclosure, and student responsibility.', type: 'assessment' as const, time: '15–20 min' }] : []),
...
export default function Home() {
  ...
  function renderStructuredWeek() {
    ...
    if (selectedItem) return <>
      ...
      {selectedItem.type === 'assessment' && selectedWeek === 10 && selectedItem.id === 'quiz-10-lesson-1' && (() => {
