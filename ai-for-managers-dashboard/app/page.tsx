...
export default function Home() {
  ...
  function renderStructuredWeek() {
    ...
    return <>
      ...
      <section className="lmsPanel glancePanel"><div className="panelBar"><h3>Week at a glance</h3><span>Teach → practice → apply → assess</span></div><div className="glanceGrid">{(selectedWeek === 6 ? [['Learn', '1.5–2 hrs'], ['Practice', '45–60 min'], ['Apply', '35–50 min'], ['Build', '45–75 min'], ['Assess', '45–65 min'], ['Reflect', '15–20 min']] : [['Learn', '2–2.5 hrs'], ['Practice', '1–1.5 hrs'], ['Apply', '30–45 min'], ['Build', '60–90 min'], ['Assess', '55–80 min'], ['Reflect', '15–20 min']]).map(([label, time]) => <div key={label}><strong>{label}</strong><span>{time}</span></div>)}</div></section>
