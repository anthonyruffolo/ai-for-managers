...
const standardModule = (week: number, overview: string, objectives: string[], artifact: string, buildDescription: string, lessons: string[], practice: string, assessment: string, submission: string) => ({
  ...
  items: [
    ...
    ...(week === 10 ? [{ id: 'quiz-10-lesson-1', title: 'Lesson 1: Academic Integrity', description: 'Check your understanding of honest AI use, support versus substitution, disclosure, and student responsibility.', type: 'quiz' as const, time: '15–20 min' }] : []),
...
export default function Home() {
  ...
  function renderStructuredWeek() {
    ...
    const typeLabel: Record<ModuleItem['type'], string> = { lesson: 'LEARN', practice: 'PRACTICE', case: 'APPLY', build: 'BUILD', assessment: 'ASSESS', quiz: 'QUIZ', submit: 'SUBMIT', reflect: 'REFLECT', resource: 'RESOURCES', connect: 'CONNECT' };
    ...
    if (selectedItem) return <>
      ...
      {selectedWeek === 10 && ((selectedItem.type === 'quiz' && selectedItem.id === 'quiz-10-lesson-1') || (selectedItem.type === 'lesson' && lessonIndex === 0)) && (() => {
        const submitted = Boolean(structuredAnswers['week10-academic-integrity-submitted']);
      ...
      {selectedWeek === 10 && selectedItem.type === 'lesson' && lessonIndex === 1 && (() => {
        const submitted = Boolean(structuredAnswers['week10-support-substitution-submitted']);
      ...
      {selectedWeek === 10 && selectedItem.type === 'lesson' && lessonIndex === 2 && (() => {
        const submitted = Boolean(structuredAnswers['week10-attribution-submitted']);
