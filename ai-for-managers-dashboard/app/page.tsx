...
const structuredModules: Record<number, { overview: string; objectives: string[]; artifact: string; buildDescription: string; items: ModuleItem[] }> = {
  ...
  7: {
    ...
    items: [
      ...
      { id: 'practice-maturity', title: 'AI Governance Maturity', description: 'Evaluate Palmetto from ad hoc practice to continuous improvement and choose the next three changes.', type: 'practice', time: '20 min' },
      ...
      { id: 'assessment-capstone', title: 'Final Governance Challenge', description: 'Classify Palmetto use cases and connect the decisions to your Responsible AI Policy.', type: 'assessment', time: '30 min' },
